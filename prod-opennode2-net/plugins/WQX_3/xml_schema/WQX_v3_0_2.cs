namespace Windsor.Node2008.WNOSPlugin.WQX3XsdOrm
{
    ...
    [AppliedAttribute(typeof(OrganizationDescriptionDataType), "OrganizationIdentifier", typeof(ColumnAttribute), "ORGID", DbType.AnsiString, 35, false)]
    [AppliedAttribute(typeof(OrganizationDescriptionDataType), "OrganizationFormalName", typeof(ColumnAttribute), "ORGFORMALNAME", DbType.AnsiString, 255, false)]
    ...
    [AppliedAttribute(typeof(ProjectDataType), "ProjectIdentifier", typeof(ColumnAttribute), "PROJECTID", DbType.AnsiString, 55, false)]
    [AppliedAttribute(typeof(ProjectDataType), "ProjectName", typeof(ColumnAttribute), "PROJECTNAME", DbType.AnsiString, 512, false)]
    [AppliedAttribute(typeof(ProjectDataType), "ProjectDescriptionText", typeof(ColumnAttribute), "PROJECTDESC", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(MonitoringLocationIdentityDataType), "MonitoringLocationIdentifier", typeof(ColumnAttribute), "MONITORINGLOCATIONID", DbType.AnsiString, 55, false)]
    ...
    [AppliedAttribute(typeof(MonitoringLocationIdentityDataType), "MonitoringLocationDescriptionText", typeof(ColumnAttribute), "MONLOCDESC", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(MonitoringLocationIdentityDataType), "TribalLandName", typeof(ColumnAttribute), "TRIBALLANDNAME", DbType.AnsiString, 512, true)]
    ...
    [AppliedAttribute(typeof(MonitoringLocationGeospatialDataType), "SourceMapScale", typeof(ColumnAttribute), "SOURCEMAPSCALE", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("MonitoringLocationGeospatial.HorizontalAccuracyMeasure.MeasureValue", typeof(ColumnAttribute), "HORIZACCURACYMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("MonitoringLocationGeospatial.VerticalMeasure.MeasureValue", typeof(ColumnAttribute), "VERTICALMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(WellInformationDataType), "AquiferTypeName", typeof(ColumnAttribute), "AQUIFERNAME", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(WellInformationDataType), "NationalAquiferCode", typeof(ColumnAttribute), "NATIONALAQUIFERCODE", DbType.AnsiString, 120, true)]
    ...
    [AppliedAttribute(typeof(IndexTypeDataType), "IndexTypeIdentifier", typeof(ColumnAttribute), "INDEXTYPEID", DbType.AnsiString, 50, false)]
    ...
    [AppliedAttribute(typeof(IndexTypeDataType), "IndexTypeName", typeof(ColumnAttribute), "INDEXTYPENAME", DbType.AnsiString, 100, false)]
    ...
    [AppliedPathAttribute("IndexTypeCitation.ResourceSubjectText", typeof(ColumnAttribute), "RESOURCESUBJECT", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(BiologicalHabitatIndexDataType), "IndexScore", typeof(ColumnAttribute), "INDEXSCORE", DbType.AnsiString, 60, false)]
    [AppliedAttribute(typeof(BiologicalHabitatIndexDataType), "IndexQualifierCode", typeof(ColumnAttribute), "INDEXQUALIFIERCODE", DbType.AnsiString, 35, true)]
    ...
    [AppliedAttribute(typeof(BiologicalHabitatIndexDataType), "MonitoringLocationIdentifier", typeof(ColumnAttribute), "MONLOCID", DbType.AnsiString, 55, false)]

    // ActivityDataType
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "ActivityIdentifier", typeof(DbIndexableAttribute))]
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "ActivityIdentifier", typeof(ColumnAttribute), "ACTIVITYID", DbType.AnsiString, 55, false)]
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "ActivityIdentifierUserSupplied", typeof(ColumnAttribute), "ACTIVITYIDUSERSUPPLIED", DbType.AnsiString, 55, true)]
    ...
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "ActivityMediaSubdivisionName", typeof(ColumnAttribute), "ACTIVITYMEDIASUBDIVISION", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "ActivityRelativeDepthName", typeof(ColumnAttribute), "RELATIVEDEPTH", DbType.AnsiString, 30, true)]
    [AppliedPathAttribute("ActivityDepthHeightMeasure.MeasureValue", typeof(ColumnAttribute), "DEPTHHEIGHTMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("ActivityTopDepthHeightMeasure.MeasureValue", typeof(ColumnAttribute), "TOPDEPTHHEIGHTMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("ActivityBottomDepthHeightMeasure.MeasureValue", typeof(ColumnAttribute), "BOTTOMDEPTHHEIGHTMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "MonitoringLocationIdentifier", typeof(ColumnAttribute), "MONLOCID", DbType.AnsiString, 55, true)]
    [AppliedAttribute(typeof(ActivityDescriptionDataType), "SamplingComponentName", typeof(ColumnAttribute), "SAMPLINGCOMPONENTNAME", DbType.AnsiString, 120, true)]
    ...
    [AppliedAttribute(typeof(ActivityLocationDataType), "SourceMapScale", typeof(ColumnAttribute), "SOURCEMAPSCALE", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("ActivityLocation.HorizontalAccuracyMeasure.MeasureValue", typeof(ColumnAttribute), "HORIZACCURACYMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityLocationDataType), "ActivityLocationDescriptionText", typeof(ColumnAttribute), "ACTIVITYLOCATIONDESCRIPTION", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(BiologicalHabitatCollectionInformationDataType), "CollectionDescriptionText", typeof(ColumnAttribute), "COLLECTIONDESCRIPTION", DbType.AnsiString, 4000, true)]
    [AppliedAttribute(typeof(BiologicalHabitatCollectionInformationDataType), "PassCount", typeof(ColumnAttribute), "BIOHABPASSCOUNT", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(NetInformationDataType), "NetTypeName", typeof(ColumnAttribute), "BIOHABNETTYPE", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("NetSurfaceAreaMeasure.MeasureValue", typeof(ColumnAttribute), "BIOHABNETSURFACEAREAMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("NetMeshSizeMeasure.MeasureValue", typeof(ColumnAttribute), "BIOHABNETMESHSIZEMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("BoatSpeedMeasure.MeasureValue", typeof(ColumnAttribute), "BIOHABNETBOATSPEEDMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("CurrentSpeedMeasure.MeasureValue", typeof(ColumnAttribute), "BIOHABNETCURRSPEEDMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(BiologicalActivityDescriptionDataType), "ToxicityTestType", typeof(ColumnAttribute), "BIOACTIVITYTOXICITYTESTTYPE", DbType.AnsiString, 30, true)]
    [AppliedAttribute(typeof(BiologicalActivityDescriptionDataType), "HabitatSelectionMethod", typeof(ColumnAttribute), "HABITATSELECTIONMETHOD", DbType.AnsiString, 35, true)]
    [AppliedPathAttribute("SampleCollectionMethod.MethodIdentifier", typeof(ColumnAttribute), "SAMPCOLLMETHODID", DbType.AnsiString, 35, true)]
    ...
    [AppliedPathAttribute("SampleCollectionMethod.MethodName", typeof(ColumnAttribute), "SAMPCOLLMETHOD", DbType.AnsiString, 250, true)]
    ...
    [AppliedPathAttribute("SampleCollectionMethod.MethodDescriptionText", typeof(ColumnAttribute), "SAMPCOLLMETHODDESC", DbType.AnsiString, 4000, true)]
    [AppliedAttribute(typeof(SampleDescriptionDataType), "SampleCollectionEquipmentName", typeof(ColumnAttribute), "SAMPCOLLEQUIPMENT", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(SampleDescriptionDataType), "HydrologicCondition", typeof(ColumnAttribute), "HYDROLOGICCONDITION", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(SampleDescriptionDataType), "HydrologicEvent", typeof(ColumnAttribute), "HYDROLOGICEVENT", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("SamplePreparationMethod.MethodIdentifier", typeof(ColumnAttribute), "SAMPPREPID", DbType.AnsiString, 35, true)]
    ...
    [AppliedPathAttribute("SamplePreparationMethod.MethodName", typeof(ColumnAttribute), "SAMPPREP", DbType.AnsiString, 250, true)]
    ...
    [AppliedPathAttribute("SamplePreparationMethod.MethodDescriptionText", typeof(ColumnAttribute), "SAMPPREPDESC", DbType.AnsiString, 4000, true)]
    [AppliedAttribute(typeof(SamplePreparationDataType), "SampleContainerLabelName", typeof(ColumnAttribute), "SAMPPREPCONTLABEL", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(SamplePreparationDataType), "SampleContainerTypeName", typeof(ColumnAttribute), "SAMPPREPCONTTYPE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(SamplePreparationDataType), "SampleContainerColorName", typeof(ColumnAttribute), "SAMPPREPCONTCOLOR", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityGroupDataType), "ActivityGroupName", typeof(ColumnAttribute), "ACTIVITYGROUPNAME", DbType.AnsiString, 120, false)]
    ...
    [AppliedAttribute(typeof(ActivityGroupDataType), "ReplaceActivities", typeof(ColumnAttribute), "REPLACEACTIVITIES", DbType.AnsiStringFixedLength, 1, true)]
    ...
    [AppliedAttribute(typeof(ProjectMonitoringLocationWeightingDataType), "MonitoringLocationIdentifier", typeof(ColumnAttribute), "MONLOCID", DbType.AnsiString, 55, false)]
    [AppliedPathAttribute("LocationWeightingFactorMeasure.MeasureValue", typeof(ColumnAttribute), "LOCWEIGHTINGFACMEASURE", DbType.AnsiString, 60, false)]
    ...
    [AppliedPathAttribute("ReferenceLocationCitation.ResourceSubjectText", typeof(ColumnAttribute), "RESOURCESUBJECT", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(ActivityMetricTypeDataType), "MetricTypeIdentifier", typeof(ColumnAttribute), "METRICTYPEID", DbType.AnsiString, 50, false)]
    ...
    [AppliedAttribute(typeof(ActivityMetricTypeDataType), "MetricTypeName", typeof(ColumnAttribute), "METRICTYPENAME", DbType.AnsiString, 100, true)]
    ...
    [AppliedAttribute(typeof(ActivityMetricTypeDataType), "FormulaDescriptionText", typeof(ColumnAttribute), "METRICTYPEFORMULADESC", DbType.AnsiString, 4000, true)]
    [AppliedPathAttribute("MetricValueMeasure.MeasureValue", typeof(ColumnAttribute), "METRICVALUEMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityMetricDataType), "MetricScore", typeof(ColumnAttribute), "METRICSCORE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(ActivityMetricDataType), "MetricSamplingPointPlaceInSeries", typeof(ColumnAttribute), "METRICSAMPPOINTPLACEINSERIES", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ActivityMetricDataType), "IndexIdentifier", typeof(ColumnAttribute), "METRICINDEXID", DbType.AnsiString, 55, true)]

    // ResultDataType
    [AppliedAttribute(typeof(ResultDescriptionDataType), "DataLoggerLineName", typeof(ColumnAttribute), "DATALOGGERLINENAME", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ResultDescriptionDataType), "CharacteristicName", typeof(ColumnAttribute), "CHARACTERISTICNAME", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(ResultDescriptionDataType), "CharacteristicNameUserSupplied", typeof(ColumnAttribute), "CHARACTERISTICNAMEUSERSUPPLIED", DbType.AnsiString, 255, true)]
    ...
    [AppliedAttribute(typeof(ResultDescriptionDataType), "StatisticalNValueNumeric", typeof(ColumnAttribute), "STATISTICALNVALUE", DbType.AnsiString, 10, true)]
    ...
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultWeightBasisText", typeof(ColumnAttribute), "WEIGHTBASIS", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultParticleSizeBasisText", typeof(ColumnAttribute), "PARTICLESIZEBASIS", DbType.AnsiString, 40, true)]
    ...
    [AppliedAttribute(typeof(DataQualityDataType), "ConfidenceIntervalValue", typeof(ColumnAttribute), "CONFIDENCEINTERVALVALUE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(DataQualityDataType), "UpperConfidenceLimitValue", typeof(ColumnAttribute), "UPPERCONFIDENCELIMITVALUE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(DataQualityDataType), "LowerConfidenceLimitValue", typeof(ColumnAttribute), "LOWERCONFIDENCELIMITVALUE", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("ResultDepthHeightMeasure.MeasureValue", typeof(ColumnAttribute), "DEPTHHEIGHTMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultSamplingPointName", typeof(ColumnAttribute), "RESULTSAMPPOINT", DbType.AnsiString, 120, true)]
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultSamplingPointType", typeof(ColumnAttribute), "RESULTSAMPPOINTTYPE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultSamplingPointPlaceInSeries", typeof(ColumnAttribute), "RESULTSAMPPOINTPLACEINSERIES", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(ResultDescriptionDataType), "ResultSamplingPointCommentText", typeof(ColumnAttribute), "RESULTSAMPPOINTCOMMENT", DbType.AnsiString, 4000, true)]
    [AppliedAttribute(typeof(ResultDescriptionDataType), "RecordIdentifierUserSupplied", typeof(ColumnAttribute), "RECORDIDUSERSUPPLIED", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "BiologicalIndividualIdentifier", typeof(ColumnAttribute), "BIORESULTINDIVIDUALID", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "SubjectTaxonomicName", typeof(ColumnAttribute), "BIORESULTSUBJECTTAXONOMIC", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "SubjectTaxonomicNameUserSupplied", typeof(ColumnAttribute), "BIORESULTSUBJECTTAXONOMICUS", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "SubjectTaxonomicNameUserSuppliedReferenceText", typeof(ColumnAttribute), "BIORESULTSUBJECTTAXONOMICUSRT", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "UnidentifiedSpeciesIdentifier", typeof(ColumnAttribute), "BIORESULTUNIDENTIFIEDSPECIESID", DbType.AnsiString, 255, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "SampleTissueAnatomyName", typeof(ColumnAttribute), "BIORESULTSAMPTISSUEANATOMY", DbType.AnsiString, 50, true)]
    [AppliedAttribute(typeof(BiologicalResultDescriptionDataType), "GroupSummaryCount", typeof(ColumnAttribute), "BIORESULTGROUPSUMMARYCOUNT", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("GroupSummaryWeightMeasure.MeasureValue", typeof(ColumnAttribute), "GRPSUMMCOUNTWEIGHTMEASURE", DbType.AnsiString, 60, true)]
    [AppliedPathAttribute("GroupSummaryWeightMeasure.MeasureUnitCode", typeof(ColumnAttribute), "GRPSUMMCOUNTWEIGHTMEASUREUNIT", DbType.AnsiString, 12, true)]
    ...
    [AppliedAttribute(typeof(TaxonomicDetailsDataType), "TaxonomicPollutionTolerance", typeof(ColumnAttribute), "TAXDETAILSPOLLTOLERANCE", DbType.AnsiString, 30, true)]
    ...
    [AppliedAttribute(typeof(TaxonomicDetailsDataType), "TrophicLevelName", typeof(ColumnAttribute), "TAXDETAILSTROPHICLEVEL", DbType.AnsiString, 30, true)]
    //??** string[] FunctionalFeedingGroupName
    [AppliedAttribute(typeof(TaxonomicDetailsDataType), "FunctionalFeedingGroupNameDBValue", typeof(ColumnAttribute), "TAXDETAILSFUNCFEEDINGGROUP", DbType.AnsiString, 30, true)]
    ...
    [AppliedAttribute(typeof(FrequencyClassInformationDataType), "LowerClassBoundValue", typeof(ColumnAttribute), "FREQCLASSLOWERBOUNDVALUE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(FrequencyClassInformationDataType), "UpperClassBoundValue", typeof(ColumnAttribute), "FREQCLASSUPPERBOUNDVALUE", DbType.AnsiString, 60, true)]
    [AppliedAttribute(typeof(ResultAnalyticalMethodDataType), "MethodIdentifier", typeof(ColumnAttribute), "ANALYTICALMETHODID", DbType.AnsiString, 35, true)]
    ...
    [AppliedAttribute(typeof(ResultAnalyticalMethodDataType), "MethodName", typeof(ColumnAttribute), "ANALYTICALMETHODNAME", DbType.AnsiString, 250, true)]
    ...
    [AppliedAttribute(typeof(ResultAnalyticalMethodDataType), "MethodDescriptionText", typeof(ColumnAttribute), "ANALYTICALMETHODDESC", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(ResultLabInformationDataType), "LaboratoryCommentText", typeof(ColumnAttribute), "LABCOMMENT", DbType.AnsiString, 4000, true)]
    [AppliedAttribute(typeof(ResultLabInformationDataType), "LaboratorySampleSplitRatio", typeof(ColumnAttribute), "LABSAMPLESPLITRATIO", DbType.AnsiString, 60, true)]
    ...
    [AppliedPathAttribute("DetectionQuantitationLimitMeasure.MeasureValue", typeof(ColumnAttribute), "DETECTQUANTLIMITMEASURE", DbType.AnsiString, 60, true)]
    ...
    [AppliedAttribute(typeof(DetectionQuantitationLimitDataType), "DetectionQuantitationLimitCommentText", typeof(ColumnAttribute), "DETECTQUANTLIMITCOMMENT", DbType.AnsiString, 4000, true)]

    // LabSamplePreparationDataType
    [AppliedPathAttribute("LabSamplePreparationMethod.MethodIdentifier", typeof(ColumnAttribute), "METHODID", DbType.AnsiString, 35, false)]
    ...
    [AppliedPathAttribute("LabSamplePreparationMethod.MethodName", typeof(ColumnAttribute), "METHODNAME", DbType.AnsiString, 250, false)]
    ...
    [AppliedPathAttribute("LabSamplePreparationMethod.MethodDescriptionText", typeof(ColumnAttribute), "METHODDESC", DbType.AnsiString, 4000, true)]
    ...
    [AppliedAttribute(typeof(LabSamplePreparationDataType), "SubstanceDilutionFactor", typeof(ColumnAttribute), "SUBSTANCEDILUTIONFACTOR", DbType.AnsiString, 60, true)]

    // AlternateMonitoringLocationIdentityDataType
    [AppliedAttribute(typeof(AlternateMonitoringLocationIdentityDataType), "MonitoringLocationIdentifier", typeof(ColumnAttribute), "MONLOCID", DbType.AnsiString, 55, false)]
    ...
    [AppliedAttribute(typeof(OrganizationDeleteDataType), "OrganizationIdentifier", typeof(ColumnAttribute), "ORGID", DbType.AnsiString, 35, false)]
    ...
    public partial class ActivityDescriptionDataType
    {
        ...
        [System.Xml.Serialization.XmlIgnore]
        [Column("TMPPROJECTID", DbType.AnsiString, 55, IsNullable = true)]
        public string TmpProjectId;
    }
