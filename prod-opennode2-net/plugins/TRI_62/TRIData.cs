                ...
                using (TransactionScope scope = new TransactionScope(TransactionScopeOption.Required, TimeSpan.FromSeconds(commandTimeoutInSeconds)))
                {
                    ...
                    foreach (SubmissionDataType submit in triObjectInstance.Submission)
                    {
                        ...
                        foreach (ReportDataType rep in submit.Report)
                        {
                            ...
                            rep.TechnicalContactPhoneExtText,
                            ...
                            if (rep.OnsiteReleaseQuantity != null)
                            {
                                foreach (OnsiteReleaseQuantityDataType orc in rep.OnsiteReleaseQuantity)
                                {
                                    ...
                                    Execute(TRIDBTableType.TRI_ONSITE_RELEASE_Q,
                                            ...
                                            (orc.WaterStream == null) ? null : orc.WaterStream.StreamReachCode
                                            );
                                    ...
                                    if (sra != null)
                                    {
                                        ...
                                        if (sra is SourceReductionActivityDataType)
                                        {
                                            ...
                                            Execute(TRIDBTableType.TRI_SRC_RED_ACT,
                                                ...
                                                null,
                                                sradt.SourceReductionEfficiencyCode);
                            ...
                            if ((rep.TRIComment != null) && (rep.TRIComment.Length > 0))
                            {
                                ...
                                {
                                    Execute(TRIDBTableType.TRI_COMMENT, NewID(),
                                            rep.PK,
                                            GetSpecifiedValue(cdt.TRICommentSequenceSpecified, cdt.TRICommentSequence),
                                            cdt.TRICommentSection,
                                            cdt.TRICommentType,
                                            cdt.TRICommentTypeDescription,
                                            cdt.TRICommentText,
                                            cdt.TRICommentP2Classification
                                            );
                                }
                            }
