...
namespace Windsor.Node2008.WNOSPlugin.TRI4
{
    ...
    public interface ITRIData
    {
        void Abort(string tranID);
        void Load(TRIDataType triObjectInstance);
    }

    public class TRIData : IInitializingObject, ITRIData
    {
        ...
        public void AfterPropertiesSet()
        {
            ...
            {
                throw new ArgumentException("ConnectionId not set.");
            }

            _db = DatabaseFactory.CreateDatabase(_connectionId);
        ...
        public void Abort(string tranID)
        {
            try
            {
                ...
                LOG.Error("Abording Transaction Id: " + tranID);

                string delete = string.Format("delete from TRI_SUB where TRANSACTION_ID = '{0}'", tranID);

                _db.ExecuteNonQuery(CommandType.Text, delete);
        ...
        public void Load(TRIDataType triObjectInstance)
        {
            ...
            foreach (SubmissionDataType submit in triObjectInstance.Submission)
            {
                ...
                else
                {
                    ...
                    Execute(TRIDBTableType.TRI_FAC,
                        ...
                        submit.Facility.GeographicLocationDescription.GeographicReferencePoint.GeographicReferencePointCode,//??
                        submit.Facility.GeographicLocationDescription.GeographicReferencePoint.GeographicReferencePointName,//??
                        submit.Facility.GeographicLocationDescription.VerticalCollectionMethod.MethodIdentifierCodeListIdentifier.Value,
                        submit.Facility.GeographicLocationDescription.VerticalCollectionMethod.MethodName,//??
                        submit.Facility.GeographicLocationDescription.VerticalCollectionMethod.MethodDescriptionText,//??
                        submit.Facility.GeographicLocationDescription.VerticalCollectionMethod.MethodDeviationsText,//??
