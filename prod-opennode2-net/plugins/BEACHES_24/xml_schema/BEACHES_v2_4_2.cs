...
using Windsor.Node2008.WNOSPlugin.BEACHES_24;
using System.Linq;
...
[assembly: AppliedAttribute(typeof(BeachSwimSeasonLengthDetailDataType), "SwimSeasonDayMeasure", typeof(ColumnAttribute), "SWIMSEASONDAYMEASURE", DbType.Decimal)]
...
[assembly: AppliedAttribute(typeof(BeachDetailDataType), "ActivityDeleteDetail", typeof(DbIgnoreAttribute))]
[assembly: AppliedAttribute(typeof(AdvReportingFrequencyDetail), "AdvReportingFrequencyMeasure", typeof(ColumnAttribute), "ADVREPORTINGFREQUENCYMEASURE", DbType.Decimal)]
[assembly: AppliedAttribute(typeof(AdvReportingFrequencyDetail), "AdvReportingFrequencyUnitOfMeasureCode", typeof(ColumnAttribute), "ADVREPORTINGFREQUNITOFMEASURE", 9)]
...
[assembly: AppliedAttribute(typeof(ActivityDataType), "ActivityPartialDayAmount", typeof(ColumnAttribute), "ACTIVITYPARTIALDAYAMOUNT", DbType.Decimal)]
...
[assembly: AppliedAttribute(typeof(CriterionMeasureDataType), "MeasureTypeName", typeof(ColumnAttribute), "MEASURETYPENAME", 5, false)]
...
namespace Windsor.Node2008.WNOSPlugin.BEACHES_24
{
    ...
    public partial class BeachDetailDataType
    {
        ...
        [System.Xml.Serialization.XmlIgnore]
        public ActivityDeleteDatatype[] ActivityDeleteDetailArray;
        ...
        public void BeforeSaveToDatabase()
        {
            ...
            if (!CollectionUtils.IsNullOrEmpty(ActivityDeleteDetail))
            {
                ActivityDeleteDetailArray = ActivityDeleteDetail.Select(e => new ActivityDeleteDatatype() { ActivityCodeNumber = e }).ToArray();
            }
        ...
        public void AfterLoadFromDatabase()
        {
            ...
            if (!CollectionUtils.IsNullOrEmpty(ActivityDeleteDetailArray))
            {
                ActivityDeleteDetail = ActivityDeleteDetailArray.Select(e => e.ActivityCodeNumber).ToArray();
            }
            CollectionUtils.ForEach(BeachActivityDetail, delegate(ActivityDataType activity)
            {
    ...
    [Table("NOTIF_BEACHACTIVITYDELETE")]
    [DefaultTableNamePrefixAttribute("NOTIF")]
    [ShortenNamesByRemovingVowelsFirstAttribute]
    [FixShortenNameBreakBugAttribute]
    [DefaultDecimalPrecision(16, 6)]
    public partial class ActivityDeleteDatatype
    {
        [System.Xml.Serialization.XmlIgnore]
        [GuidPrimaryKey("ID", IndexName = "PK_NOT_BCHACTDEL")]
        public string Id;

        [System.Xml.Serialization.XmlIgnore]
        [GuidForeignKey("BEACH_ID", IndexName = "FK_NOT_BCHACTDEL")]
        public string BeachId;

        [System.Xml.Serialization.XmlIgnore]
        [DbNotNull]
        [Column("ACTIVITYCODENUMBER", DbType.Decimal)]
        public string ActivityCodeNumber;
    }
}
