/* This script creates the staging tables for the Beach Notification v2.4 data flow for OpenNode2 */

-- Brensmith 9/26/2019 - Using v2.2 baseline, modified to accomodate schema v2.4
...
ALTER TABLE NOTIF_BEACHACTIVITYDELETE
 DROP CONSTRAINT FK_BEACHACTIVITYDELETE_BEACH
/
...
ALTER TABLE NOTIF_BEACHACTIVITYDELETE
 DROP CONSTRAINT PK_NOTIF_BEACHACTIVITYDELETE
/
...
DROP INDEX PK_NOTIF_BEACHACTIVITYDELETE
/
...
DROP TABLE NOTIF_BEACHACTIVITYDELETE
/
...
CREATE TABLE "NOTIF_BEACH" ( 
    ...
    "ADVREPORTINGFREQUNITOFMEASURE"     VARCHAR2(9) NULL 
	);
...
CREATE TABLE "NOTIF_BEACHCRITERION" (
    ...
    "MEASURETYPENAME"				VARCHAR2(5) NOT NULL, --changed from 4 to 5 chars in v2.3, v2.4
...
ALTER TABLE "NOTIF_BEACHACTIVITYDELETE"
	ADD ( CONSTRAINT "PK_NOTIF_BEACHACTIVITYDELETE"
	PRIMARY KEY ("ID")
	NOT DEFERRABLE INITIALLY IMMEDIATE );
...
ALTER TABLE "NOTIF_BEACHACTIVITYDELETE"
	ADD ( CONSTRAINT "FK_BEACHACTIVITYDELETE_BEACH"
	FOREIGN KEY("BEACH_ID")
	REFERENCES "NOTIF_BEACH"("ID")
	ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE VALIDATE );
