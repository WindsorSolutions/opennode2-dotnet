/*************************************************************************************************
** ObjectName: TRI_6.2-ORA-DLL.sql
**
...
ALTER TABLE "TRI_CHEM_REACTNT_SUBCATG" 
 DROP CONSTRAINT "FK_CHEM_REACTNT_SUBCATG_CODE_REPORT";
 
ALTER TABLE "TRI_CHEM_PRCSS_AID_SUBCATG" 
 DROP CONSTRAINT "FK_CHEM_PRCSS_AID_SUBCATG_CODE_REPORT";

ALTER TABLE "TRI_CHEM_MFG_AID_SUBCATG" 
 DROP CONSTRAINT "FK_CHEM_MFG_AID_SUBCATG_CODE_REPORT";

ALTER TABLE "TRI_CHEM_FRMLN_CMPNT_SUBCATG" 
 DROP CONSTRAINT "FK_CHEM_FRMLN_CMPNT_SUBCATG_CODE_REPORT";

ALTER TABLE "TRI_CHEM_ANCLRY_USAGE_SUBCATG" 
 DROP CONSTRAINT "FK_CHEM_ANCLRY_USAGE_SUBCATG_CODE_REPORT";
 
--Drop PKs, UKs and Indexes
ALTER TABLE "TRI_SUB"
...
ALTER TABLE "TRI_CHEM_ANCLRY_USAGE_SUBCATG"
	DROP CONSTRAINT "PK_TRI_CHEM_ANCLRY_USAGE_SUBCATG";

ALTER TABLE "TRI_CHEM_FRMLN_CMPNT_SUBCATG"
	DROP CONSTRAINT "PK_TRI_CHEM_FRMLN_CMPNT_SUBCATG";

ALTER TABLE "TRI_CHEM_MFG_AID_SUBCATG"
	DROP CONSTRAINT "PK_TRI_CHEM_MFG_AID_SUBCATG";

ALTER TABLE "TRI_CHEM_PRCSS_AID_SUBCATG"
	DROP CONSTRAINT "PK_TRI_CHEM_PRCSS_AID_SUBCATG";

ALTER TABLE "TRI_CHEM_REACTNT_SUBCATG"
	DROP CONSTRAINT "PK_TRI_CHEM_REACTNT_SUBCATG";
...
DROP INDEX "PK_TRI_CHEM_ANCLRY_USAGE_SUBCATG";

DROP INDEX "PK_TRI_CHEM_FRMLN_CMPNT_SUBCATG" ;

DROP INDEX "PK_TRI_CHEM_MFG_AID_SUBCATG";

DROP INDEX "PK_TRI_CHEM_PRCSS_AID_SUBCATG";

DROP INDEX "PK_TRI_CHEM_REACTNT_SUBCATG";
...
DROP TABLE "TRI_CHEM_REACTNT_SUBCATG";

DROP TABLE "TRI_CHEM_PRCSS_AID_SUBCATG";

DROP TABLE "TRI_CHEM_MFG_AID_SUBCATG";

DROP TABLE "TRI_CHEM_FRMLN_CMPNT_SUBCATG";

DROP TABLE "TRI_CHEM_ANCLRY_USAGE_SUBCATG";
...
CREATE TABLE "TRI_FAC" (
	...
	"FRGN_PARENT_COMPANY_TXT" VARCHAR2(100) NULL,
	"FRGN_PARENT_COMPANY_NAME_N_S" CHAR(1) NULL,
	"FRGN_PARENT_DUN_CODE" VARCHAR2(100) NULL
 );
...
CREATE TABLE "TRI_POTW_WASTE_QUANTITY" (
	...
	"POTW_TRANSFER_TYPE_CODE" VARCHAR2(32) NULL,
	"POTW_TRANSFER_SEQ_NUMBER" VARCHAR2(100) NULL
 );
...
CREATE TABLE "TRI_REPORT" (
	...
	"FORM_PREP_METH" VARCHAR2(32) NULL,
	"WASTE_ROCK_MGD_PILE_IND" CHAR(1) NULL,
	"WASTE_ROCK_QTY" VARCHAR2(100) NULL
 );
...
CREATE TABLE "TRI_TRANSFER_LOC" (
	...
	"RCRA_ID_CLBER" VARCHAR2(100) NULL,
	"EPA_REGISTRY_ID" VARCHAR2(32) NULL
 );
