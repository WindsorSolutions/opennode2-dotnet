DROP SEQUENCE RCRA_HD_CERTIFICATION_S
/
DROP SEQUENCE RCRA_HD_ENV_PERMIT_S
/
DROP SEQUENCE RCRA_HD_HANDLER_S
/
DROP SEQUENCE RCRA_HD_HBASIC_S
/
DROP SEQUENCE RCRA_HD_NAICS_S
/
DROP SEQUENCE RCRA_HD_OTHER_ID_S
/
DROP SEQUENCE RCRA_HD_OWNEROP_S
/
DROP SEQUENCE RCRA_HD_STATE_ACTIVITY_S
/
DROP SEQUENCE RCRA_HD_UNIVERSAL_WASTE_S
/
DROP SEQUENCE RCRA_HD_WASTE_CODE_S
/
...
CREATE SEQUENCE RCRA_HD_CERTIFICATION_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_ENV_PERMIT_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_HANDLER_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_HBASIC_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_NAICS_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_OTHER_ID_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_OWNEROP_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_STATE_ACTIVITY_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_UNIVERSAL_WASTE_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
CREATE SEQUENCE RCRA_HD_WASTE_CODE_S INCREMENT BY 1 START WITH 1 NOMAXVALUE MINVALUE 0 NOCYCLE CACHE 20 ORDER
/
