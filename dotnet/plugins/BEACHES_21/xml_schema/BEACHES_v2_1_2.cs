...
using Windsor.Node2008.WNOSPlugin.BEACHES_21;

[assembly: DefaultTableNamePrefixAttribute("NOTIF")]
[assembly: ShortenNamesByRemovingVowelsFirstAttribute]
[assembly: FixShortenNameBreakBugAttribute]
[assembly: DefaultDecimalPrecision(19, 14)]
...
[assembly: AppliedAttribute(typeof(ActivityDataType), "ActivityMonitoringStationIdentifier", typeof(ColumnAttribute), "MONITORINGSTATIONIDENTIFIER", 65)]
...
namespace Windsor.Node2008.WNOSPlugin.BEACHES_21
{
    public partial class BeachDataSubmissionDataType : IBeforeSaveToDatabase, IAfterLoadFromDatabase
    {
        public void BeforeSaveToDatabase()
        {
            ...
            {
                organizationDetail.Id = Guid.NewGuid().ToString();
            ...
            CollectionUtils.ForEach(BeachDetail, delegate(BeachDetailDataType beachDetail)
            {
                ...
                beachDetail.Id = Guid.NewGuid().ToString();
            ...
            CollectionUtils.ForEach(BeachProcedureDetail, delegate(BeachProcedureDetailDataType beachProcedureDetail)
            {
                ...
                if (beachProcedureDetail.ProcedureBeachIdentifier.Length > 1)
                {
                    string checkValue = beachProcedureDetail.ProcedureBeachIdentifier[0];
                    bool containsOnlyOne = true;
                    for (int i = 1; i < beachProcedureDetail.ProcedureBeachIdentifier.Length; ++i)
                    {
                        if (checkValue != beachProcedureDetail.ProcedureBeachIdentifier[i])
                        {
                            containsOnlyOne = false;
                            break;
                        }
                    }
                    if (!containsOnlyOne)
                    {
                        throw new ArgumentException(string.Format("The BeachProcedureDetail with Identifier \"{0}\" has more than one associated BeachDetail Identifier",
                                                                  beachProcedureDetail.ProcedureIdentifier));
                    }
                }
                string beachId;
                if (!beachIdentifierToPrimaryKeyMap.TryGetValue(beachProcedureDetail.ProcedureBeachIdentifier[0], out beachId))
                {
                ...
                beachProcedureDetail.BeachId = beachId;
            });
        }
        public void AfterLoadFromDatabase()
        {
            ...
            CollectionUtils.ForEach(BeachProcedureDetail, delegate(BeachProcedureDetailDataType beachProcedureDetail)
            {
                ...
                if (!beachPrimaryKeyToIdentifierMap.TryGetValue(beachProcedureDetail.BeachId, out beachIdentifier))
                {
                    throw new ArgumentException(string.Format("The BeachProcedureDetail with ID \"{0}\" references a BeachDetail with ID \"{1}\" that cannot be found",
                                                              beachProcedureDetail.Id, beachProcedureDetail.BeachId));
                }
                beachProcedureDetail.ProcedureBeachIdentifier = new string[1];
                beachProcedureDetail.ProcedureBeachIdentifier[0] = beachIdentifier;
            });
        }
    }
    ...
    {
        [System.Xml.Serialization.XmlIgnore]
        [GuidPrimaryKey("ID", IndexName = "PK_NOT_BCH_PRO")]
        public string Id;

        [System.Xml.Serialization.XmlIgnore]
        [Column("BEACH_ID", 40, IsNullable = false)]
        [DbIndexableAttribute]
        public string BeachId;
    }
