...
#else // !V_3
                        if (datum.TransactionProtocolDetails.CompositeTypeIdentifier != null)
                        {
                            argNames.Append(';').Append("COMPOSITE_TYPE_ID");
                            args.Add(datum.TransactionProtocolDetails.CompositeTypeIdentifier);
                        }
                        if (datum.TransactionProtocolDetails.DurationCode != null)
                        {
                            argNames.Append(';').Append("DURATION_CD");
                            args.Add(datum.TransactionProtocolDetails.DurationCode);
                        }
#endif // !V_3
