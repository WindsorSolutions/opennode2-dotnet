...
namespace Windsor.Node2008.WNOSPlugin.RCRA_52
{
    ...
    [AppliedAttribute(typeof(SiteWasteActivityDataType), "StateDistrictCodeText", typeof(ColumnAttribute), "STATE_DISTRICT_TEXT", 255)]
    ...
    [AppliedAttribute(typeof(HazardousSecondaryMaterialActivityDataType), "LandBasedUnitIndicatorText", typeof(ColumnAttribute), "LAND_BASED_UNIT_IND_TEXT", DbType.AnsiStringFixedLength, 255)]
