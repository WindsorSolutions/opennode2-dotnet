<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true"
    Codebehind="ConfigPartnerEdit.aspx.cs" Inherits="Windsor.Node2008.Admin.Secure.ConfigPartnerEdit"
    ...
    <table id="formTable" width="100%" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <td class="ctrl" width="750">
                ...
                <asp:CustomValidator ID="CustomValidator7" runat="server" ErrorMessage="Required" ValidateEmptyText="True" OnServerValidate="ServerValidateRequiredIfVisible" ControlToValidate="nameCtrl"/>
            </td>
        </tr>
        <tr>
            ...
            <td class="ctrl">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="error"
                        Display="Dynamic" ErrorMessage="Required" ControlToValidate="endpointCtrl"></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="endpointCtrl"
                    CssClass="error" Display="Dynamic" ErrorMessage="Invalid Format" ValidationExpression="^http(s?)\:\/\/[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*(:(0-9)*)*(\/?)([a-zA-Z0-9\-\.\?\,\'\/\\\+&amp;%\$#_]*)?$"></asp:RegularExpressionValidator></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="command" colspan="2" align="right">
                ...
                <input type="button" value="Cancel" class="button" onclick="location.href='ConfigPartner.aspx'" />
