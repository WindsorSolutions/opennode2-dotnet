...
namespace Windsor.Commons.Core
{
    ...
    public class xDirectory
    {
        ...
        /// </summary>
        private IList<string> _FileFilters = new List<string>();
        ...
        /// <summary>
        /// The 'Copy' Method: Sync Call to perform the Copy Process.
        /// </summary>
        public void Copy()
        {
            DoCopy(false);
        ...
        /// The 'Start Copy' Method: Async Call to Start the Copy Process.
        /// </summary>
        protected void DoCopy(bool isAsync)
        {
            try
            {
                if (_CopierStatus != xDirectoryStatus.Stopped)
        ...
        /// <param name="FileFilter">The File Filter.</param>
        /// <param name="FolderFilter">The Folder Filter.</param>
        public static void Copy(string Source, string Destination, bool includeSubfolders, bool overwrite,
                                params string[] fileFilters)
        {
            try
            {
                xDirectory copier = new xDirectory();
                copier._Source = new DirectoryInfo(Source);
                copier._Destination = new DirectoryInfo(Destination);
                copier._FileFilters = fileFilters;
                copier._IncludeSubfolders = includeSubfolders;
                copier.Overwrite = overwrite;
