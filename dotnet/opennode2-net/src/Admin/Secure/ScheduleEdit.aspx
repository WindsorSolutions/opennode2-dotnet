                ...
                <table id="Table5" width="98%" cellpadding="2" cellspacing="0">
                    <tr valign="middle">
                        ...
                        <td width="100%" nowrap="nowrap" valign="middle">
                            ...
                            <asp:CustomValidator ID="destinationSubmitServiceValidator" runat="server" ErrorMessage="Destination local service is required." ValidateEmptyText="True" OnServerValidate="ServerValidateNotSelectedControl" ControlToValidate="destinationSubmitServiceDropDownList" Text="*" />
                        </td>
                    </tr>
                    <tr valign="middle">
                        <td align="right" nowrap="nowrap">
