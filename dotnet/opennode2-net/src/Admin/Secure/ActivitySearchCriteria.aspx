...
<asp:Content ID="Content1" ContentPlaceHolderID="SecureContentHolder" runat="server">
    ...
    <table id="formTable" width="100%" cellpadding="2" cellspacing="0">
        ...
        <tr>
            <td class="label" nowrap="nowrap" style="width: 120px" valign="middle" style="vertical-align: middle">
                Date Range:
            </td>
            <td nowrap="nowrap" colspan="3" align="left" valign="middle" style="vertical-align: middle">
                <table id="Table1" cellpadding="2" cellspacing="0">
                    <tr align="left" valign="middle" style="vertical-align: middle">
                        <td valign="middle" style="vertical-align: middle">
                            From:
                        </td>
                        <td valign="middle" valign="middle" style="vertical-align: middle">
        ...
        <tr>
            ...
            <td class="command" colspan="2" align="right">
                ...
                <asp:Button ID="DeleteAllButton" Text="Delete All" CssClass="button" runat="server" OnClick="OnDeleteAllActivities" CausesValidation="false" OnClientClick="return confirm('Are you sure you want to delete all activities that match the current search criteria?\n\nIMPORTANT: Activities cannot be recovered once deleted.');" />
            </td>
        </tr>
    </table>
    ...
    <asp:GridView ID="resultsGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False" GridLines="None" Width="100%" Font-Names="Verdana,Arial,Helvetica,sans-serif" Font-Size="Small" OnRowDataBound="resultsGridView_RowDataBound" AllowPaging="True" BorderStyle="Solid" BorderWidth="3px" Font-Bold="False" CellPadding="3" OnSorting="resultsGridView_Sorting" BorderColor="#90B4CF" ForeColor="Black" EnableViewState="False" HorizontalAlign="Center">
        ...
        <Columns>
            <asp:TemplateField HeaderText="" ItemStyle-Width="20px" ItemStyle-Wrap="False" ItemStyle-HorizontalAlign="Center">
                ...
                <ItemStyle HorizontalAlign="Center" Wrap="False" Width="20px"></ItemStyle>
            </asp:TemplateField>
            ...
            <asp:BoundField HeaderText="Operation" ReadOnly="True" DataField="Operation" ItemStyle-Width="300px" ItemStyle-Wrap="True" SortExpression="Operation">
        ...
        <PagerTemplate>
            <table width="100%">
                <tr align="left" valign="middle">
                    ...
                    <td class="command" align="right" style="width: 100%" nowrap="nowrap">
                    </td>
                </tr>
            </table>
        </PagerTemplate>
