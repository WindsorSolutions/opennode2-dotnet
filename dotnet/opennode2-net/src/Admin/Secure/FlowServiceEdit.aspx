...
--%>        <tr>
            ...
            <td class="ctrl">
                <asp:CheckBox ID="activeCheckBox" runat="server" Text="Note: Making this service inactive will prevent it from being accessible using the Web Service interface." Font-Size="Smaller" CausesValidation="false" />
            </td>
        </tr>
        <tr>
            <td class="label" width="50" style="vertical-align: top">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="right" nowrap="nowrap">
                                    <asp:CheckBox ID="globalValueCheckBox" runat="server" AutoPostBack="True" OnCheckedChanged="OnGlobalValueCheckBoxChanged" TextAlign="Left" Text="Use global value " Font-Size="X-Small" CausesValidation="false" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="100%">
