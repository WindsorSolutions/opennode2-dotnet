...
ALTER TABLE NOTIF_BEACH MODIFY BEACHNAME VARCHAR2(60) NULL; --Nullable

ALTER TABLE NOTIF_BEACH MODIFY BEACHDESCRIPTION VARCHAR2(255) NULL; --Nullable

ALTER TABLE NOTIF_BEACH MODIFY BEACHSTATECODE CHAR(2) NULL; --Nullable

ALTER TABLE NOTIF_BEACH MODIFY BEACHFIPSCOUNTYCODE VARCHAR2(5) NULL; --Nullable

ALTER TABLE NOTIF_BEACH MODIFY BEACHACCESSTYPE VARCHAR2(12) NULL; --Nullable

ALTER TABLE NOTIF_BEACH MODIFY SWIMSEASONFREQUENCYMEASURE NUMBER(16,6); --Changed Datatype

ALTER TABLE NOTIF_BEACH MODIFY OFFSEASONFREQUENCYMEASURE NUMBER(16,6); --Changed Datatype


ALTER TABLE NOTIF_PERSON MODIFY FIRSTNAME VARCHAR2(50) NULL; --Nullable

ALTER TABLE NOTIF_PERSON MODIFY LASTNAME  VARCHAR2(50) NULL; --Nullable

ALTER TABLE NOTIF_PERSON MODIFY PERSONSTATUS VARCHAR2(8) NULL; --Nullable


ALTER TABLE NOTIF_BEACHACTIVITY MODIFY EXTENTSTARTMEASURE NUMBER(16,6); --Changed Datatype
 
ALTER TABLE NOTIF_BEACHACTIVITY MODIFY EXTENTLENGTHMEASURE NUMBER(16,6); --Changed Datatype

ALTER TABLE NOTIF_BEACHACTIVITY MODIFY ACTUALSTOPDATE VARCHAR2(25) NULL; --Nullable
...
CREATE TABLE "NOTIF_BEACHCRITERION" (
    ...
    "MEASUREVALUE"					NUMBER(16,6) NOT NULL,
