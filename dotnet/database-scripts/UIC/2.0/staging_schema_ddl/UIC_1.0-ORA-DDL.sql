...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_CONSTITUENT" 
   (	"CONSTITUENT_DETAIL_TYPE_ID" VARCHAR2(40), 
	"WASTE_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_CONSTITUENT"."CONSTITUENT_DETAIL_TYPE_ID" IS 'Parent: Container for Constituent information. (_PK)';
 
   COMMENT ON COLUMN "UIC_CONSTITUENT"."WASTE_DETAIL_TYPE_ID" IS 'Parent: Container for Constituent information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_CONTACT" 
   (	"CONTACT_DETAIL_TYPE_ID" VARCHAR2(40), 
	"ORG_ID" VARCHAR2(4), 
   ...
   COMMENT ON COLUMN "UIC_CONTACT"."CONTACT_DETAIL_TYPE_ID" IS 'Parent: Container for Contact information. (_PK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_CORRECTION" 
   (	"CORRECTION_DETAIL_TYPE_ID" VARCHAR2(40), 
	"WELL_INSP_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_CORRECTION"."CORRECTION_DETAIL_TYPE_ID" IS 'Parent: Container for Correction information. (_PK)';
 
   COMMENT ON COLUMN "UIC_CORRECTION"."WELL_INSP_DETAIL_TYPE_ID" IS 'Parent: Container for Correction information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_ENFORCEMENT" 
   (	"ENFORCEMENT_DETAIL_TYPE_ID" VARCHAR2(40), 
	"ORG_ID" VARCHAR2(4), 
   ...
   COMMENT ON COLUMN "UIC_ENFORCEMENT"."ENFORCEMENT_DETAIL_TYPE_ID" IS 'Parent: Container for Enforcement information. (_PK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_ENGINEERING" 
   (	"ENGR_DETAIL_TYPE_ID" VARCHAR2(40), 
	"WELL_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_ENGINEERING"."ENGR_DETAIL_TYPE_ID" IS 'Parent: Container for Engineering information. (_PK)';
 
   COMMENT ON COLUMN "UIC_ENGINEERING"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Engineering information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_FACILITY" 
   (	"FACILITY_LIST_TYPE_ID" VARCHAR2(40), 
	"ORG_ID" VARCHAR2(4), 
   ...
   COMMENT ON COLUMN "UIC_FACILITY"."FACILITY_LIST_TYPE_ID" IS 'Parent: Container for multiple Facility information submissions. (_PK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_FACILITY_INSPECTION" 
   (	"FACILITY_INSP_DETAIL_TYPE_ID" VARCHAR2(40), 
	"FACILITY_LIST_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_FACILITY_INSPECTION"."FACILITY_INSP_DETAIL_TYPE_ID" IS 'Parent: Container for Facility Inspection information. (_PK)';
 
   COMMENT ON COLUMN "UIC_FACILITY_INSPECTION"."FACILITY_LIST_TYPE_ID" IS 'Parent: Container for Facility Inspection information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_FACILITY_RESPONSE" 
   (	"FACILITY_RESPONSE_DETAIL_ID" VARCHAR2(40), 
	"FCILITY_VIOLTION_DETIL_TYPE_ID" VARCHAR2(40), 
	"RESPONSE_ENFORCEMENT_IDENT" VARCHAR2(20), 
	"RESPONSE_VIOLATION_IDENT" VARCHAR2(20)
   ) ;
 

   COMMENT ON COLUMN "UIC_FACILITY_RESPONSE"."FACILITY_RESPONSE_DETAIL_ID" IS 'Parent: Container for Response information. (_PK)';
 
   COMMENT ON COLUMN "UIC_FACILITY_RESPONSE"."FCILITY_VIOLTION_DETIL_TYPE_ID" IS 'Parent: Container for Response information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_FACILITY_VIOLATION" 
   ...
   COMMENT ON COLUMN "UIC_FACILITY_VIOLATION"."FCILITY_VIOLTION_DETIL_TYPE_ID" IS 'Parent: Container for Facility Violation information. (_PK)';
 
   COMMENT ON COLUMN "UIC_FACILITY_VIOLATION"."FACILITY_LIST_TYPE_ID" IS 'Parent: Container for Facility Violation information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_GEOLOGY" 
   (	"GEO_DETAIL_TYPE_ID" VARCHAR2(40), 
	"ORG_ID" VARCHAR2(4), 
   ...
   COMMENT ON COLUMN "UIC_GEOLOGY"."GEO_DETAIL_TYPE_ID" IS 'Parent: Container for Geology information. (_PK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_MI_TEST" 
   (	"MI_TST_DETAIL_TYPE_ID" VARCHAR2(40), 
	"WELL_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_MI_TEST"."MI_TST_DETAIL_TYPE_ID" IS 'Parent: Container for MI Test information. (_PK)';
 
   COMMENT ON COLUMN "UIC_MI_TEST"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for MI Test information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_PERMIT" 
   (	"PERMIT_DETAIL_TYPE_ID" VARCHAR2(40), 
	"ORG_ID" VARCHAR2(4), 
   ...
   COMMENT ON COLUMN "UIC_PERMIT"."PERMIT_DETAIL_TYPE_ID" IS 'Parent: Container for Permit information. (_PK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_PERMIT_ACTIVITY" 
   (	"PERMIT_ACT_DETAIL_TYPE_ID" VARCHAR2(40), 
	"PERMIT_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_PERMIT_ACTIVITY"."PERMIT_ACT_DETAIL_TYPE_ID" IS 'Parent: Container for Permit Activity information. (_PK)';
 
   COMMENT ON COLUMN "UIC_PERMIT_ACTIVITY"."PERMIT_DETAIL_TYPE_ID" IS 'Parent: Container for Permit Activity information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WASTE" 
   ...
   COMMENT ON COLUMN "UIC_WASTE"."WASTE_DETAIL_TYPE_ID" IS 'Parent: Container for Waste information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WASTE"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Waste information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL" 
   ...
   COMMENT ON COLUMN "UIC_WELL"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Well information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL"."FACILITY_LIST_TYPE_ID" IS 'Parent: Container for Well information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL_INSPECTION" 
   ...
   COMMENT ON COLUMN "UIC_WELL_INSPECTION"."WELL_INSP_DETAIL_TYPE_ID" IS 'Parent: Container for Well Inspection information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL_INSPECTION"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Well Inspection information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL_RESPONSE" 
   (	"WELL_RESPONSE_DETAIL_ID" VARCHAR2(40), 
	"WELL_VIOLATION_DETAIL_TYPE_ID" VARCHAR2(40), 
	"RESPONSE_ENFORCEMENT_IDENT" VARCHAR2(20), 
	"RESPONSE_VIOLATION_IDENT" VARCHAR2(20)
   ) ;
 

   COMMENT ON COLUMN "UIC_WELL_RESPONSE"."WELL_RESPONSE_DETAIL_ID" IS 'Parent: Container for Response information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL_RESPONSE"."WELL_VIOLATION_DETAIL_TYPE_ID" IS 'Parent: Container for Response information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL_STATUS" 
   (	"WELL_STATUS_DETAIL_TYPE_ID" VARCHAR2(40), 
	"WELL_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_WELL_STATUS"."WELL_STATUS_DETAIL_TYPE_ID" IS 'Parent: Container for Well Status information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL_STATUS"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Well Status information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL_TYPE" 
   (	"WELL_TYPE_DETAIL_ID" VARCHAR2(40), 
	"WELL_DETAIL_TYPE_ID" VARCHAR2(40), 
   ...
   COMMENT ON COLUMN "UIC_WELL_TYPE"."WELL_TYPE_DETAIL_ID" IS 'Parent: Container for Well Type information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL_TYPE"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Well Type information. (_FK)';
...
--------------------------------------------------------
  ...
  CREATE TABLE "UIC_WELL_VIOLATION" 
   ...
   COMMENT ON COLUMN "UIC_WELL_VIOLATION"."WELL_VIOLATION_DETAIL_TYPE_ID" IS 'Parent: Container for Well Violation information. (_PK)';
 
   COMMENT ON COLUMN "UIC_WELL_VIOLATION"."WELL_DETAIL_TYPE_ID" IS 'Parent: Container for Well Violation information. (_FK)';
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_ENFORCEMENT" ADD CONSTRAINT "PK_ENFORCEMENT" PRIMARY KEY ("ENFORCEMENT_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_ENFORCEMENT" MODIFY ("ENFORCEMENT_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_GEOLOGY" ADD CONSTRAINT "PK_GEOLOGY" PRIMARY KEY ("GEO_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_GEOLOGY" MODIFY ("GEO_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_PERMIT_ACTIVITY" ADD CONSTRAINT "PK_PERMIT_ACTIVITY" PRIMARY KEY ("PERMIT_ACT_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_PERMIT_ACTIVITY" MODIFY ("PERMIT_ACT_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_PERMIT_ACTIVITY" MODIFY ("PERMIT_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL_INSPECTION" ADD CONSTRAINT "PK_WELL_INSPECTION" PRIMARY KEY ("WELL_INSP_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL_INSPECTION" MODIFY ("WELL_INSP_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL_INSPECTION" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_ENGINEERING" ADD CONSTRAINT "PK_ENGINEERING" PRIMARY KEY ("ENGR_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_ENGINEERING" MODIFY ("ENGR_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_ENGINEERING" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL_RESPONSE" ADD CONSTRAINT "PK_WELL_RESPONSE" PRIMARY KEY ("WELL_RESPONSE_DETAIL_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL_RESPONSE" MODIFY ("WELL_RESPONSE_DETAIL_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL_RESPONSE" MODIFY ("WELL_VIOLATION_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL" ADD CONSTRAINT "PK_WELL" PRIMARY KEY ("WELL_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL" MODIFY ("FACILITY_LIST_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WASTE" ADD CONSTRAINT "PK_WASTE" PRIMARY KEY ("WASTE_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_WASTE" MODIFY ("WASTE_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WASTE" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_CORRECTION" ADD CONSTRAINT "PK_CORRECTION" PRIMARY KEY ("CORRECTION_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_CORRECTION" MODIFY ("CORRECTION_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_CORRECTION" MODIFY ("WELL_INSP_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_FACILITY_INSPECTION" ADD CONSTRAINT "PK_FCILTY_INSPCTON" PRIMARY KEY ("FACILITY_INSP_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_FACILITY_INSPECTION" MODIFY ("FACILITY_INSP_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_FACILITY_INSPECTION" MODIFY ("FACILITY_LIST_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_CONTACT" ADD CONSTRAINT "PK_CONTACT" PRIMARY KEY ("CONTACT_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_CONTACT" MODIFY ("CONTACT_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL_VIOLATION" ADD CONSTRAINT "PK_WELL_VIOLATION" PRIMARY KEY ("WELL_VIOLATION_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL_VIOLATION" MODIFY ("WELL_VIOLATION_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL_VIOLATION" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_FACILITY" ADD CONSTRAINT "PK_FACILITY" PRIMARY KEY ("FACILITY_LIST_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_FACILITY" MODIFY ("FACILITY_LIST_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_CONSTITUENT" ADD CONSTRAINT "PK_CONSTITUENT" PRIMARY KEY ("CONSTITUENT_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_CONSTITUENT" MODIFY ("CONSTITUENT_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_CONSTITUENT" MODIFY ("WASTE_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL_STATUS" ADD CONSTRAINT "PK_WELL_STATUS" PRIMARY KEY ("WELL_STATUS_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL_STATUS" MODIFY ("WELL_STATUS_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL_STATUS" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_WELL_TYPE" ADD CONSTRAINT "PK_WELL_TYPE" PRIMARY KEY ("WELL_TYPE_DETAIL_ID") ENABLE;
 
  ALTER TABLE "UIC_WELL_TYPE" MODIFY ("WELL_TYPE_DETAIL_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_WELL_TYPE" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_FACILITY_RESPONSE" ADD CONSTRAINT "PK_FCILITY_RSPONSE" PRIMARY KEY ("FACILITY_RESPONSE_DETAIL_ID") ENABLE;
 
  ALTER TABLE "UIC_FACILITY_RESPONSE" MODIFY ("FACILITY_RESPONSE_DETAIL_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_FACILITY_RESPONSE" MODIFY ("FCILITY_VIOLTION_DETIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_PERMIT" ADD CONSTRAINT "PK_PERMIT" PRIMARY KEY ("PERMIT_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_PERMIT" MODIFY ("PERMIT_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_FACILITY_VIOLATION" ADD CONSTRAINT "PK_FCILITY_VIOLTON" PRIMARY KEY ("FCILITY_VIOLTION_DETIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_FACILITY_VIOLATION" MODIFY ("FCILITY_VIOLTION_DETIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_FACILITY_VIOLATION" MODIFY ("FACILITY_LIST_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_MI_TEST" ADD CONSTRAINT "PK_MI_TEST" PRIMARY KEY ("MI_TST_DETAIL_TYPE_ID") ENABLE;
 
  ALTER TABLE "UIC_MI_TEST" MODIFY ("MI_TST_DETAIL_TYPE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "UIC_MI_TEST" MODIFY ("WELL_DETAIL_TYPE_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
--  DDL for Index IX_WL_RS_WL_VL_DT
--------------------------------------------------------

  CREATE INDEX "IX_WL_RS_WL_VL_DT" ON "UIC_WELL_RESPONSE" ("WELL_VIOLATION_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WELL
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WELL" ON "UIC_WELL" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_CORRECTION
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_CORRECTION" ON "UIC_CORRECTION" ("CORRECTION_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_FACILITY" ON "UIC_FACILITY" ("FACILITY_LIST_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_ENG_WL_DT_TY_ID
--------------------------------------------------------

  CREATE INDEX "IX_ENG_WL_DT_TY_ID" ON "UIC_ENGINEERING" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_FCILTY_INSPCTON
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_FCILTY_INSPCTON" ON "UIC_FACILITY_INSPECTION" ("FACILITY_INSP_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index IX_PR_AC_PR_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_PR_AC_PR_DT_TY" ON "UIC_PERMIT_ACTIVITY" ("PERMIT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_CONSTITUENT
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_CONSTITUENT" ON "UIC_CONSTITUENT" ("CONSTITUENT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_WST_WL_DT_TY_ID
--------------------------------------------------------

  CREATE INDEX "IX_WST_WL_DT_TY_ID" ON "UIC_WASTE" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_CR_WL_IN_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_CR_WL_IN_DT_TY" ON "UIC_CORRECTION" ("WELL_INSP_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_ENFORCEMENT
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_ENFORCEMENT" ON "UIC_ENFORCEMENT" ("ENFORCEMENT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WELL_STATUS
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WELL_STATUS" ON "UIC_WELL_STATUS" ("WELL_STATUS_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_ENGINEERING
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_ENGINEERING" ON "UIC_ENGINEERING" ("ENGR_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "PK_WELL_INSPECTION" ON "UIC_WELL_INSPECTION" ("WELL_INSP_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_WL_ST_WL_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_WL_ST_WL_DT_TY" ON "UIC_WELL_STATUS" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index IX_FC_RS_FC_VL_DT
--------------------------------------------------------

  CREATE INDEX "IX_FC_RS_FC_VL_DT" ON "UIC_FACILITY_RESPONSE" ("FCILITY_VIOLTION_DETIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_PERMIT
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_PERMIT" ON "UIC_PERMIT" ("PERMIT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_MI_TEST
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_MI_TEST" ON "UIC_MI_TEST" ("MI_TST_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WASTE
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WASTE" ON "UIC_WASTE" ("WASTE_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_CNS_WS_DT_TY_ID
--------------------------------------------------------

  CREATE INDEX "IX_CNS_WS_DT_TY_ID" ON "UIC_CONSTITUENT" ("WASTE_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ;
--------------------------------------------------------
--  DDL for Index IX_WL_IN_WL_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_WL_IN_WL_DT_TY" ON "UIC_WELL_INSPECTION" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WELL_VIOLATION
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WELL_VIOLATION" ON "UIC_WELL_VIOLATION" ("WELL_VIOLATION_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WELL_TYPE
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WELL_TYPE" ON "UIC_WELL_TYPE" ("WELL_TYPE_DETAIL_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_FCILITY_RSPONSE
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_FCILITY_RSPONSE" ON "UIC_FACILITY_RESPONSE" ("FACILITY_RESPONSE_DETAIL_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_CONTACT
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_CONTACT" ON "UIC_CONTACT" ("CONTACT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_WL_VL_WL_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_WL_VL_WL_DT_TY" ON "UIC_WELL_VIOLATION" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_WELL_RESPONSE
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_WELL_RESPONSE" ON "UIC_WELL_RESPONSE" ("WELL_RESPONSE_DETAIL_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_GEOLOGY
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_GEOLOGY" ON "UIC_GEOLOGY" ("GEO_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_FCILITY_VIOLTON
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_FCILITY_VIOLTON" ON "UIC_FACILITY_VIOLATION" ("FCILITY_VIOLTION_DETIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_FC_IN_FC_LS_TY
--------------------------------------------------------

  CREATE INDEX "IX_FC_IN_FC_LS_TY" ON "UIC_FACILITY_INSPECTION" ("FACILITY_LIST_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_WLL_FC_LS_TY_ID
--------------------------------------------------------

  CREATE INDEX "IX_WLL_FC_LS_TY_ID" ON "UIC_WELL" ("FACILITY_LIST_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_MI_TS_WL_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_MI_TS_WL_DT_TY" ON "UIC_MI_TEST" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_WL_TY_WL_DT_TY
--------------------------------------------------------

  CREATE INDEX "IX_WL_TY_WL_DT_TY" ON "UIC_WELL_TYPE" ("WELL_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index IX_FC_VL_FC_LS_TY
--------------------------------------------------------

  CREATE INDEX "IX_FC_VL_FC_LS_TY" ON "UIC_FACILITY_VIOLATION" ("FACILITY_LIST_TYPE_ID") 
  ;
--------------------------------------------------------
--  DDL for Index PK_PERMIT_ACTIVITY
--------------------------------------------------------

  CREATE UNIQUE INDEX "PK_PERMIT_ACTIVITY" ON "UIC_PERMIT_ACTIVITY" ("PERMIT_ACT_DETAIL_TYPE_ID") 
  ;
--------------------------------------------------------
--  Ref Constraints for Table UIC_CONSTITUENT
--------------------------------------------------------

  ALTER TABLE "UIC_CONSTITUENT" ADD CONSTRAINT "FK_CONSTITUNT_WSTE" FOREIGN KEY ("WASTE_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WASTE" ("WASTE_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_CORRECTION" ADD CONSTRAINT "FK_CRRCT_WLL_INSPC" FOREIGN KEY ("WELL_INSP_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL_INSPECTION" ("WELL_INSP_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_ENGINEERING" ADD CONSTRAINT "FK_ENGINEERING_WLL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_FACILITY_INSPECTION" ADD CONSTRAINT "FK_FCLTY_INSP_FCLT" FOREIGN KEY ("FACILITY_LIST_TYPE_ID")
	  REFERENCES "UIC_FACILITY" ("FACILITY_LIST_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_FACILITY_RESPONSE
--------------------------------------------------------

  ALTER TABLE "UIC_FACILITY_RESPONSE" ADD CONSTRAINT "FK_FCL_RSP_FCL_VLT" FOREIGN KEY ("FCILITY_VIOLTION_DETIL_TYPE_ID")
	  REFERENCES "UIC_FACILITY_VIOLATION" ("FCILITY_VIOLTION_DETIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_FACILITY_VIOLATION
--------------------------------------------------------

  ALTER TABLE "UIC_FACILITY_VIOLATION" ADD CONSTRAINT "FK_FCLTY_VLTN_FCLT" FOREIGN KEY ("FACILITY_LIST_TYPE_ID")
	  REFERENCES "UIC_FACILITY" ("FACILITY_LIST_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_MI_TEST" ADD CONSTRAINT "FK_MI_TEST_WELL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "UIC_PERMIT_ACTIVITY" ADD CONSTRAINT "FK_PRMT_ACTVT_PRMT" FOREIGN KEY ("PERMIT_DETAIL_TYPE_ID")
	  REFERENCES "UIC_PERMIT" ("PERMIT_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WASTE
--------------------------------------------------------

  ALTER TABLE "UIC_WASTE" ADD CONSTRAINT "FK_WASTE_WELL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL
--------------------------------------------------------

  ALTER TABLE "UIC_WELL" ADD CONSTRAINT "FK_WELL_FACILITY" FOREIGN KEY ("FACILITY_LIST_TYPE_ID")
	  REFERENCES "UIC_FACILITY" ("FACILITY_LIST_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL_INSPECTION
--------------------------------------------------------

  ALTER TABLE "UIC_WELL_INSPECTION" ADD CONSTRAINT "FK_WLL_INSPCTN_WLL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL_RESPONSE
--------------------------------------------------------

  ALTER TABLE "UIC_WELL_RESPONSE" ADD CONSTRAINT "FK_WLL_RSP_WLL_VLT" FOREIGN KEY ("WELL_VIOLATION_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL_VIOLATION" ("WELL_VIOLATION_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL_STATUS
--------------------------------------------------------

  ALTER TABLE "UIC_WELL_STATUS" ADD CONSTRAINT "FK_WELL_STATUS_WLL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL_TYPE
--------------------------------------------------------

  ALTER TABLE "UIC_WELL_TYPE" ADD CONSTRAINT "FK_WELL_TYPE_WELL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table UIC_WELL_VIOLATION
--------------------------------------------------------

  ALTER TABLE "UIC_WELL_VIOLATION" ADD CONSTRAINT "FK_WLL_VIOLTON_WLL" FOREIGN KEY ("WELL_DETAIL_TYPE_ID")
	  REFERENCES "UIC_WELL" ("WELL_DETAIL_TYPE_ID") ON DELETE CASCADE ENABLE;
