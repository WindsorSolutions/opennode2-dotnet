...
<table id="contentTable">
	<tr>
		...
		<div style="clear: both; text-align: right; margin-bottom: 10px">
				<input type="button" name="cmdBack" value="Back" class="button"
					onclick="history.back()" style="width:120px"  /></div>
		...
		<c:choose>
			...
			<c:when test="${model.tran != null}">
				...
				<td colspan="2"><strong>Transaction Details</strong></td>
                    ...
                    <tr>
                        <td class="label" width="50" style="text-align: right; vertical-align: top;">Method:</td>
