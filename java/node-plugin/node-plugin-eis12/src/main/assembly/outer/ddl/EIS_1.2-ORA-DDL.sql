...
--  Modified the following columsn's datatype to support the EPA EIS schema.
-- CERS_EMIS_UNIT:
-- Before:
--  [PCNT_CTRL_APCH_CAP_EFCY] [decimal](12, 6) NULL,
--  [PCNT_CTRL_APCH_EFCT] [decimal](12, 6) NULL,
--  [PCNT_CTRL_APCH_PEN] [decimal](12, 6) NULL,
-- After:
...
--
--
-- CERS_EMS_UNT_CTRL_APCH_CTR_PLT:
-- Before:
--   [PCNT_CTRL_MEAS_REDC_EFCY] [decimal](12, 6) NULL,
-- After:
...
-- Before:
--   [AVE_PCNT_EMIS] [decimal](12, 6) NOT NULL,
-- After:
...
--------------------------------------------------------
 ...
 "PCNT_CTRL_APCH_CAP_EFCY" NUMBER(4, 1), 
 "PCNT_CTRL_APCH_EFCT" NUMBER(4, 1), 
 "PCNT_CTRL_APCH_PEN" NUMBER(4, 1), 
...
--------------------------------------------------------
 ...
 "PCNT_WINTER_ACT" NUMBER(4,1), 
 "PCNT_SPRING_ACT" NUMBER(4,1), 
 "PCNT_SUMMER_ACT" NUMBER(4,1), 
 "PCNT_FALL_ACT" NUMBER(4,1)
   ) ;
...
--------------------------------------------------------
 ...
 "PCNT_CTRL_MEAS_REDC_EFCY" NUMBER(4,1)
   ) ;
...
--------------------------------------------------------
 ...
 "PCNT_TEN_HOUR_FUEL_MOIS" NUMBER(4,1), 
 "PCNT_ONE_THSD_HOUR_FUEL_MOIS" NUMBER(4,1), 
 "PCNT_LIVE_FUEL_MOIS" NUMBER(4,1), 
 "PCNT_DUFF_FUEL_MOIS" NUMBER(4,1), 
...
--------------------------------------------------------
 ...
 "PCNT_AREA_PROD_EMIS" NUMBER(4,1)
   ) ;
...
--------------------------------------------------------
 ...
 "PCNT_OXYGEN_CONT" NUMBER(4,1), 
 "PCNT_MOIS_CONT" NUMBER(4,1), 
