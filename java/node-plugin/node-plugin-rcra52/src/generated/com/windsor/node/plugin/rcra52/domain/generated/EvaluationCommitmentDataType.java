...
/**
 * <p>Java class for EvaluationCommitmentDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EvaluationCommitmentDataType">
 *   &lt;complexContent>
...
@XmlType(name = "EvaluationCommitmentDataType", propOrder = {
    "transactionCode",
    "commitmentLead",
    "commitmentSequenceNumber"
})
@Entity(name = "EvaluationCommitmentDataType")
@Table(name = "RCRA_EVALCOMMIT")
@Inheritance(strategy = InheritanceType.JOINED)
public class EvaluationCommitmentDataType
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof EvaluationCommitmentDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final EvaluationCommitmentDataType that = ((EvaluationCommitmentDataType) object);
        {
