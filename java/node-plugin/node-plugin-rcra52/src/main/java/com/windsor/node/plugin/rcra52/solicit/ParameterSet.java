...
import static com.windsor.node.plugin.rcra52.solicit.SolicitOperation.*;
...
public enum ParameterSet {
    ...
    CA_BY_HANDLER(SolicitRequestType.CA_BY_HANDLER, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_CHANGE_DATE
    }),
    CA_BY_STATE(SolicitRequestType.CA_BY_STATE, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_STATE, PARAM_CHANGE_DATE
    }),
    CE_BY_HANDLER(SolicitRequestType.CE_BY_HANDLER, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_STATE, PARAM_AGENCY, PARAM_CHANGE_DATE
    }),
    ...
    CE_EVALUATION_BY_HANDLER(SolicitRequestType.CE_EVALUATION_BY_HANDLER, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_STATE, PARAM_AGENCY, PARAM_FROM_DATE, PARAM_TO_DATE, PARAM_CHANGE_DATE
    }),
    ...
    GS_BY_HANDLER(SolicitRequestType.GS_BY_HANDLER, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_CHANGE_DATE, PARAM_OWNER, PARAM_SEQUENCE_NUMBER
    }),
    ...
    HD_BY_HANDLER(SolicitRequestType.HD_BY_HANDLER, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_CHANGE_DATE, PARAM_STATE, PARAM_SOURCE_TYPE, PARAM_SEQUENCE_NUMBER
    }),
    ...
    HD_MAX_SEQUENCE(SolicitRequestType.HD_MAX_SEQUENCE, new PluginServiceParameterDescriptor[] {
            PARAM_USE_SOLICIT_HISTORY, PARAM_HANDLER_ID, PARAM_SOURCE_TYPE, PARAM_STATE
    });
