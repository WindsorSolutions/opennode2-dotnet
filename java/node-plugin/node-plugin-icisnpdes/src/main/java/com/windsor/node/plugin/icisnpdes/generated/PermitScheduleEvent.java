...
/**
 * <p>Java class for PermitScheduleEvent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PermitScheduleEvent">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.exchangenetwork.net/schema/icis/5}PermitScheduleEventKeyElements">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}ScheduleEventGroup" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PermitScheduleEvent", propOrder = {
...
@Entity(name = "PermitScheduleEvent")
@Table(name = "ICS_PRMT_SCHD_EVT")
@Inheritance(strategy = InheritanceType.JOINED)
public class PermitScheduleEvent
    extends PermitScheduleEventKeyElements
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "ICS_PRMT_SCHD_EVT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PermitScheduleEvent)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final PermitScheduleEvent that = ((PermitScheduleEvent) object);
        {
