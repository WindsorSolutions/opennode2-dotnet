...
/**
 * <p>Java class for LinkageSSOEventReport complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageSSOEventReport">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}SSOEventReportKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LinkageSSOEventReport", propOrder = {
    "permitIdentifier",
    "ssoEventDate",
    "ssoEventID"
})
@Entity(name = "LinkageSSOEventReport")
@Table(name = "ICS_LNK_SSO_EVT_REP")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageSSOEventReport
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageSSOEventReport)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageSSOEventReport that = ((LinkageSSOEventReport) object);
        {
