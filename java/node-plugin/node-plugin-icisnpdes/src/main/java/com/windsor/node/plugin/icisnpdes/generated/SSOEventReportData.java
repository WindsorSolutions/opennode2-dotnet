 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}SSOEventReport"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "ssoOverflowLocationStreet", column = @Column(name = "SSO_OVRFLW_LOC_STREET", columnDefinition = "varchar(4000)", length = 4000)),
        ...
        @AttributeOverride(name = "descriptionStepsTaken", column = @Column(name = "DESC_STPS_TAKEN", columnDefinition = "varchar(4000)", length = 4000))
    })
