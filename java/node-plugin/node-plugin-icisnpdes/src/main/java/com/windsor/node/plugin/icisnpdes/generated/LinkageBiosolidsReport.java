...
import com.windsor.node.plugin.icisnpdes.domain.AbstractComplianceMonitoringAndDmrProgramReportLinkage;
...
/**
 * <p>Java class for LinkageBiosolidsReport complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageBiosolidsReport">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}BiosolidsProgramReportKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LinkageBiosolidsReport", propOrder = {
    "permitIdentifier",
    "reportCoverageEndDate"
})
@Entity(name = "LinkageBiosolidsReport")
@Table(name = "ICS_LNK_BS_REP")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageBiosolidsReport
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageBiosolidsReport)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageBiosolidsReport that = ((LinkageBiosolidsReport) object);
        {
