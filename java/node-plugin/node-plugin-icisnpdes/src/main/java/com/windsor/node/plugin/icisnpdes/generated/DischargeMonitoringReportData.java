 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}DischargeMonitoringReport"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "reportCommentText", column = @Column(name = "REP_CMNT_TXT", columnDefinition = "varchar(4000)", length = 4000)),
