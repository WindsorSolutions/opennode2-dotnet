...
/**
 * <p>Java class for LinkageCAFOAnnualReport complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageCAFOAnnualReport">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}CAFOAnnualProgramReportKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LinkageCAFOAnnualReport", propOrder = {
    "permitIdentifier",
    "permittingAuthorityReportReceivedDate"
})
@Entity(name = "LinkageCAFOAnnualReport")
@Table(name = "ICS_LNK_CAFO_ANNUL_REP")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageCAFOAnnualReport
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageCAFOAnnualReport)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageCAFOAnnualReport that = ((LinkageCAFOAnnualReport) object);
        {
