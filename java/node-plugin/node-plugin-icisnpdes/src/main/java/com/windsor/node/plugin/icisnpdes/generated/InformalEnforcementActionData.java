    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "informalEACommentText", column = @Column(name = "INFRML_EA_CMNT_TXT", columnDefinition = "varchar(4000)", length = 4000)),
        ...
        @AttributeOverride(name = "informalEAUserDefinedField6", column = @Column(name = "INFRML_EA_USR_DFND_FLD_6", columnDefinition = "varchar(4000)", length = 4000)),
