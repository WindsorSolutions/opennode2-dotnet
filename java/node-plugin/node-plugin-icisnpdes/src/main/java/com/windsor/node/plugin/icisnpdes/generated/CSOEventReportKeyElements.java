...
/**
 * <p>Java class for CSOEventReportKeyElements complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CSOEventReportKeyElements">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}CSOEventReportKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CSOEventReportKeyElements", propOrder = {
    "permitIdentifier",
    "csoEventDate",
    "csoEventID"
})
@XmlSeeAlso({
    CSOEventReport.class
})
@MappedSuperclass
public class CSOEventReportKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CSOEventReportKeyElements)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CSOEventReportKeyElements that = ((CSOEventReportKeyElements) object);
        {
