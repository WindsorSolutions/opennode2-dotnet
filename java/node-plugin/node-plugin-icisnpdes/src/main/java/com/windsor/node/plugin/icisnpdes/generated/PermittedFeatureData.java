...
import com.windsor.node.plugin.icisnpdes.domain.AbstractPermittedFeatureData;
 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}PermittedFeature"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "tmdlCompletedIndicator", column = @Column(name = "TMDL_COMPLETED_IND", columnDefinition = "char(1)", length = 1)),
