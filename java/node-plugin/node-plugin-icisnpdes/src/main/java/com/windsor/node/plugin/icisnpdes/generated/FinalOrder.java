 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}FinalOrderPermitIdentifier" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}FinalOrderIssuedEnteredDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}NPDESClosedDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}FinalOrderQNCRComments" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}SupplementalEnvironmentalProject" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    protected List<SupplementalEnvironmentalProject> supplementalEnvironmentalProject;
    @XmlTransient
     ...
     */
    @ElementCollection
    @Column(name = "FINAL_ORDER_PRMT_IDENT", columnDefinition = "char(9)", length = 9)
     ...
     */
    @Basic
    @Column(name = "OTHR_CMNTS", columnDefinition = "varchar(4000)", length = 4000)
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SupplementalEnvironmentalProject }
     * 
     * 
     */
    @OneToMany(targetEntity = SupplementalEnvironmentalProject.class, cascade = {
        CascadeType.ALL
    })
    @JoinColumn(name = "ICS_FINAL_ORDER_ID")
    public List<SupplementalEnvironmentalProject> getSupplementalEnvironmentalProject() {
        if (supplementalEnvironmentalProject == null) {
            supplementalEnvironmentalProject = new ArrayList<SupplementalEnvironmentalProject>();
        }
     ...
     * 
     */
    public void setSupplementalEnvironmentalProject(List<SupplementalEnvironmentalProject> supplementalEnvironmentalProject) {
        this.supplementalEnvironmentalProject = supplementalEnvironmentalProject;
    }

    @Transient
    public boolean isSetSupplementalEnvironmentalProject() {
        return ((this.supplementalEnvironmentalProject!= null)&&(!this.supplementalEnvironmentalProject.isEmpty()));
    }

    public void unsetSupplementalEnvironmentalProject() {
        this.supplementalEnvironmentalProject = null;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<SupplementalEnvironmentalProject> lhsSupplementalEnvironmentalProject;
            lhsSupplementalEnvironmentalProject = (this.isSetSupplementalEnvironmentalProject()?this.getSupplementalEnvironmentalProject():null);
            List<SupplementalEnvironmentalProject> rhsSupplementalEnvironmentalProject;
            rhsSupplementalEnvironmentalProject = (that.isSetSupplementalEnvironmentalProject()?that.getSupplementalEnvironmentalProject():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<SupplementalEnvironmentalProject> theSupplementalEnvironmentalProject;
            theSupplementalEnvironmentalProject = (this.isSetSupplementalEnvironmentalProject()?this.getSupplementalEnvironmentalProject():null);
