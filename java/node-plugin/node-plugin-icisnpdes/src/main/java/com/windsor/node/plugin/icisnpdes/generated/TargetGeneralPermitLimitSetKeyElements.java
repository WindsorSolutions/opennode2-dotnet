...
/**
 * <p>Java class for TargetGeneralPermitLimitSetKeyElements complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TargetGeneralPermitLimitSetKeyElements">
 *   &lt;complexContent>
...
@XmlType(name = "TargetGeneralPermitLimitSetKeyElements", propOrder = {
    "permitIdentifier",
    "permittedFeatureIdentifier",
    "limitSetDesignator"
})
@MappedSuperclass
public class TargetGeneralPermitLimitSetKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TargetGeneralPermitLimitSetKeyElements)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TargetGeneralPermitLimitSetKeyElements that = ((TargetGeneralPermitLimitSetKeyElements) object);
        {
