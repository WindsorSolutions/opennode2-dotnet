...
/**
 * <p>Java class for LinkageSSOAnnualReport complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageSSOAnnualReport">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}SSOAnnualReportKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LinkageSSOAnnualReport", propOrder = {
    "permitIdentifier",
    "ssoAnnualReportReceivedDate"
})
@Entity(name = "LinkageSSOAnnualReport")
@Table(name = "ICS_LNK_SSO_ANNUL_REP")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageSSOAnnualReport
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageSSOAnnualReport)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageSSOAnnualReport that = ((LinkageSSOAnnualReport) object);
        {
