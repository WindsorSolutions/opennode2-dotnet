...
/**
 * <p>Java class for ViolationEnforcementDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ViolationEnforcementDataType">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/RCRA/5}ReturnComplianceScheduledDate" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ViolationEnforcementDataType", propOrder = {
    "transactionCode",
    "violationSequenceNumber",
    "agencyWhichDeterminedViolation",
    "agencyText",
    "returnComplianceScheduledDate"
})
@Entity(name = "ViolationEnforcementDataType")
@Table(name = "RCRA_VIOENFRC")
@Inheritance(strategy = InheritanceType.JOINED)
public class ViolationEnforcementDataType
    implements Equals, HashCode
{
    ...
    @XmlElement(name = "ReturnComplianceScheduledDate")
    protected XMLGregorianCalendar returnComplianceScheduledDate;
    ...
    /**
     * Gets the value of the returnComplianceScheduledDate property.
     * 
     * @return
     *     possible object is
     ...
     */
    @Transient
    public XMLGregorianCalendar getReturnComplianceScheduledDate() {
        return returnComplianceScheduledDate;
    }

    /**
     * Sets the value of the returnComplianceScheduledDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setReturnComplianceScheduledDate(XMLGregorianCalendar value) {
        this.returnComplianceScheduledDate = value;
    }
    ...
    @Basic
    @Column(name = "RETCOMPSCHEDDATEITEM")
    @Temporal(TemporalType.DATE)
    public Date getReturnComplianceScheduledDateItem() {
        return XmlAdapterUtils.unmarshall(XMLGregorianCalendarAsDate.class, this.getReturnComplianceScheduledDate());
    }

    public void setReturnComplianceScheduledDateItem(Date target) {
        setReturnComplianceScheduledDate(XmlAdapterUtils.marshall(XMLGregorianCalendarAsDate.class, target));
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ViolationEnforcementDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ViolationEnforcementDataType that = ((ViolationEnforcementDataType) object);
        {
        ...
        {
            XMLGregorianCalendar lhsReturnComplianceScheduledDate;
            lhsReturnComplianceScheduledDate = this.getReturnComplianceScheduledDate();
            XMLGregorianCalendar rhsReturnComplianceScheduledDate;
            rhsReturnComplianceScheduledDate = that.getReturnComplianceScheduledDate();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "returnComplianceScheduledDate", lhsReturnComplianceScheduledDate), LocatorUtils.property(thatLocator, "returnComplianceScheduledDate", rhsReturnComplianceScheduledDate), lhsReturnComplianceScheduledDate, rhsReturnComplianceScheduledDate)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            XMLGregorianCalendar theReturnComplianceScheduledDate;
            theReturnComplianceScheduledDate = this.getReturnComplianceScheduledDate();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "returnComplianceScheduledDate", theReturnComplianceScheduledDate), currentHashCode, theReturnComplianceScheduledDate);
        }
