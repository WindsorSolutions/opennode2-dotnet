    ...
    implements Equals, HashCode
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "srsName", column = @Column(name = "SRS_NAME", insertable = false, updatable = false)),
        @AttributeOverride(name = "srsDimension", column = @Column(name = "SRS_DIM", insertable = false, updatable = false))
    })
