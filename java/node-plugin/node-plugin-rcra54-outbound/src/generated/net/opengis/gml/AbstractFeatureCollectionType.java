    ...
    implements Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final AbstractFeatureCollectionType that = ((AbstractFeatureCollectionType) object);
        {
            ...
            lhsFeatureMember = (((this.featureMember!= null)&&(!this.featureMember.isEmpty()))?this.getFeatureMember():null);
            List<FeaturePropertyType> rhsFeatureMember;
            rhsFeatureMember = (((that.featureMember!= null)&&(!that.featureMember.isEmpty()))?that.getFeatureMember():null);
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = super.hashCode(locator, strategy);
        {
            ...
            theFeatureMember = (((this.featureMember!= null)&&(!this.featureMember.isEmpty()))?this.getFeatureMember():null);
