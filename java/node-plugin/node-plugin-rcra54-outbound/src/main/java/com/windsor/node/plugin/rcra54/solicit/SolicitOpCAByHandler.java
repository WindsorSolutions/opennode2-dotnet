...
public class SolicitOpCAByHandler extends SolicitOperation {
    ...
    public static final String SERVICE_NAME = "SolicitOpCAByHandler";
    ...
    static {
        ...
        PLUGIN_SERVICE_IMPLEMENTOR_DESCRIPTOR.setDescription("Solicits CA Data by Handler from the RCRAInfo service.");
    ...
    public SolicitRequestType getRequestType() {
        return SolicitRequestType.CA_BY_HANDLER;
    }
