...
/**
 * <p>Java class for AirFacilityKeyElements complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AirFacilityKeyElements">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}AirFacilityKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AirFacilityKeyElements", propOrder = {
...
@MappedSuperclass
public class AirFacilityKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AirFacilityKeyElements)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AirFacilityKeyElements that = ((AirFacilityKeyElements) object);
        {
