...
public class ETLStoredProcedure extends StoredProcedure
{
    ...
    private static final String OUT_WORKFLOW_ID = "p_ica_subm_track_id";
    ...
    public ETLStoredProcedure(DataSource dataSource, String sprocName)
    {
        ...
        declareParameter(new SqlOutParameter(OUT_WORKFLOW_ID, Types.VARCHAR, new RowMapper<String>()
        {
