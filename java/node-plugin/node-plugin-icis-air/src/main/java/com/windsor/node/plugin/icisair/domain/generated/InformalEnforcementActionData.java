 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}InformalEnforcementAction"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@Table(name = "ICA_INFRML_ENFRC_ACTN")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "fileNumber", column = @Column(name = "FILE_NUM", length = 50)),
     ...
     */
    @Id
    @Column(name = "ICA_INFRML_ENFRC_ACTN_ID")
