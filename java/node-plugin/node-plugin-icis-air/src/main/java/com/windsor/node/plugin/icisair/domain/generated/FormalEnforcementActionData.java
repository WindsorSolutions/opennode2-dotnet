...
@Table(name = "ICA_FRML_ENFRC_ACTN")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @AssociationOverrides({
        ...
        @AssociationOverride(name = "permitIdentifier", joinTable = @JoinTable(name = "ICA_PRMT_IDENT", joinColumns = {
            @JoinColumn(name = "ICA_FRML_ENFRC_ACTN_ID")
        })),
        @AssociationOverride(name = "enforcementActionTypeCode", joinTable = @JoinTable(name = "ICA_ENFRC_ACTN_TYPE", joinColumns = {
            @JoinColumn(name = "ICA_FRML_ENFRC_ACTN_ID")
        })),
        @AssociationOverride(name = "programsViolatedCode", joinTable = @JoinTable(name = "ICA_PROGS_VIOL", joinColumns = {
            @JoinColumn(name = "ICA_FRML_ENFRC_ACTN_ID")
        }))
    })
     ...
     */
    @Id
    @Column(name = "ICA_FRML_ENFRC_ACTN_ID")
