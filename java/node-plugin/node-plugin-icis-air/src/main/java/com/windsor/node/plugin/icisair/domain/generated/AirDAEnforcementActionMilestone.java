...
/**
 * <p>Java class for AirDAEnforcementActionMilestone complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AirDAEnforcementActionMilestone">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.exchangenetwork.net/schema/icis/5}AirDAEnforcementActionMilestoneKeyElements">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}MilestonePlannedDate" minOccurs="0"/>
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/5}MilestoneActualDate" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AirDAEnforcementActionMilestone", propOrder = {
    "milestonePlannedDate",
    "milestoneActualDate"
})
@Embeddable
public class AirDAEnforcementActionMilestone
    extends AirDAEnforcementActionMilestoneKeyElements
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Basic
    @Column(name = "MILSTN_PLANNED_DATE")
     ...
     */
    @Basic
    @Column(name = "MILSTN_ACTUAL_DATE")
    @Temporal(TemporalType.TIMESTAMP)
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AirDAEnforcementActionMilestone)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final AirDAEnforcementActionMilestone that = ((AirDAEnforcementActionMilestone) object);
        {
