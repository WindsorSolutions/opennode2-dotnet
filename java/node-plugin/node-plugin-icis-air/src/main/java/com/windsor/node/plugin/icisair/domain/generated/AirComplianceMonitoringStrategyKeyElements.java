...
/**
 * <p>Java class for AirComplianceMonitoringStrategyKeyElements complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AirComplianceMonitoringStrategyKeyElements">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.exchangenetwork.net/schema/icis/5}AirComplianceMonitoringStrategyKeyElementsGroup"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AirComplianceMonitoringStrategyKeyElements", propOrder = {
    "airFacilityIdentifier"
})
@XmlSeeAlso({
    AirComplianceMonitoringStrategy.class
})
@MappedSuperclass
public class AirComplianceMonitoringStrategyKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AirComplianceMonitoringStrategyKeyElements)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AirComplianceMonitoringStrategyKeyElements that = ((AirComplianceMonitoringStrategyKeyElements) object);
        {
