...
import com.windsor.node.plugin.icisair.domain.generated.SubmissionResult;
...
{
    private static final String SQL_COUNT_PENDING_WORKFLOWS = "SELECT count(*) from ICA_SUBM_TRACK where WORKFLOW_STAT = ?";
    private static final String SQL_LOAD_PENDING_WORKFLOW = "SELECT ICA_SUBM_TRACK_ID from ICA_SUBM_TRACK where WORKFLOW_STAT = ?";
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#countPendingWorkflows()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#loadPendingWorkflow()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#saveIcisStatusResults(java.util.List, java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#runCleanupStoredProc(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#getIcisWorkflowDao()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.windsor.node.plugin.icisair.dao.IcisStatusAndProcessingDao#setIcisWorkflowDao(com.windsor.node.plugin.icisair.dao.IcisWorkflowDao)
     */
    @Override
