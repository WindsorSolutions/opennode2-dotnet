...
/**
 * <p>Java class for AirDAEnforcementActionKeyElements complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AirDAEnforcementActionKeyElements">
 *   &lt;complexContent>
...
@XmlType(name = "AirDAEnforcementActionKeyElements", propOrder = {
    "airDAEnforcementActionIdentifier"
})
@XmlSeeAlso({
    AirDAInformalEnforcementAction.class,
    AirDAFormalEnforcementAction.class,
    AirDAEnforcementActionLinkage.class
})
@MappedSuperclass
public class AirDAEnforcementActionKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AirDAEnforcementActionKeyElements)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AirDAEnforcementActionKeyElements that = ((AirDAEnforcementActionKeyElements) object);
        {
