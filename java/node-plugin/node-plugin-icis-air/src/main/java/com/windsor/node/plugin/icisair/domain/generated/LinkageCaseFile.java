...
/**
 * <p>Java class for LinkageCaseFile complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageCaseFile">
 *   &lt;complexContent>
...
@XmlType(name = "LinkageCaseFile", propOrder = {
    "caseFileIdentifier"
})
/*@Entity(name = "LinkageCaseFile")
@Table(name = "ICA_LNK_CASE_FILE")
@Inheritance(strategy = InheritanceType.JOINED)*/
@Embeddable
public class LinkageCaseFile
    implements Serializable, Equals, HashCode
{
     ...
     */
    /*@Id
    @Column(name = "ICA_LNK_CASE_FILE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageCaseFile)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageCaseFile that = ((LinkageCaseFile) object);
        {
