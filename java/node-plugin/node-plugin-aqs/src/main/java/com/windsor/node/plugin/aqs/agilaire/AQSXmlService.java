...
public abstract interface AQSXmlService
{
  ...
  @Action(input="http://108.163.187.10/AQSXmlService/GetAQS3XmlData", output="http://www.agilairecorp.com/AQSXmlService/GetAQS3XmlDataResponse")
  ...
  @Action(input="http://108.163.187.10/AQSXmlService/GetAQSXmlData", output="http://www.agilairecorp.com/AQSXmlService/GetAQSXmlDataResponse")
  ...
  @Action(input="http://108.163.187.10/AQSXmlService/GetAQSXmlDataWeb", output="http://www.agilairecorp.com/AQSXmlService/GetAQSXmlDataWebResponse")
  ...
  @Action(input="http://108.163.187.10/AQSXmlService/GetAQSParameters", output="http://www.agilairecorp.com/AQSXmlService/GetAQSParametersResponse")
