...
/**
 * <p>Java class for MethodIdentifierCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MethodIdentifierCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "MethodIdentifierCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "MethodIdentifierCodeListIdentifierDataType")
@Table(name = "OWIR_METH_IDEN_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class MethodIdentifierCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "METH_IDEN_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MethodIdentifierCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MethodIdentifierCodeListIdentifierDataType that = ((MethodIdentifierCodeListIdentifierDataType) object);
        {
            String lhsValue;
