...
/**
 * <p>Java class for StateCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="StateCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "StateCodeListIdentifierDataType", propOrder = {
    "value"
})
@Embeddable
public class StateCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StateCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final StateCodeListIdentifierDataType that = ((StateCodeListIdentifierDataType) object);
        {
            String lhsValue;
