...
@Entity(name = "GeographicReferenceDatumCodeListIdentifierDataType")
@Table(name = "OWIR_GEOGRAPHIC_REFERENCE_DATUM_CODE_LIST_IDEN_DATA_TYPE")
    ...
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "GEOGRAPHIC_REFERENCE_DATUM_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeographicReferenceDatumCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeographicReferenceDatumCodeListIdentifierDataType that = ((GeographicReferenceDatumCodeListIdentifierDataType) object);
        {
            String lhsValue;
