...
/**
 * <p>Java class for FacilitySiteTypeCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FacilitySiteTypeCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "FacilitySiteTypeCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "FacilitySiteTypeCodeListIdentifierDataType")
@Table(name = "OWIR_FACILITY_SITE_TYPE_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class FacilitySiteTypeCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "FACILITY_SITE_TYPE_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FacilitySiteTypeCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FacilitySiteTypeCodeListIdentifierDataType that = ((FacilitySiteTypeCodeListIdentifierDataType) object);
        {
            String lhsValue;
