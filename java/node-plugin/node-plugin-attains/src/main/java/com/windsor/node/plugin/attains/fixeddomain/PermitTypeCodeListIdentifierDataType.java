...
/**
 * <p>Java class for PermitTypeCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PermitTypeCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "PermitTypeCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "PermitTypeCodeListIdentifierDataType")
@Table(name = "OWIR_PERMIT_TYPE_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class PermitTypeCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "PERMIT_TYPE_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PermitTypeCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PermitTypeCodeListIdentifierDataType that = ((PermitTypeCodeListIdentifierDataType) object);
        {
            String lhsValue;
