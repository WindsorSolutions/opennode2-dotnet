...
@Entity(name = "CountyCodeListIdentifierDataType")
@Table(name = "OWIR_COUNTY_CODE_LIST_IDEN_DATA_TYPE")
    ...
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "COUNTY_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CountyCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CountyCodeListIdentifierDataType that = ((CountyCodeListIdentifierDataType) object);
        {
            String lhsValue;
