...
/**
 * <p>Java class for FacilityManagementTypeCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FacilityManagementTypeCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "FacilityManagementTypeCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "FacilityManagementTypeCodeListIdentifierDataType")
@Table(name = "OWIR_FACILITY_MANAGEMENT_TYPE_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class FacilityManagementTypeCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "FACILITY_MANAGEMENT_TYPE_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FacilityManagementTypeCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FacilityManagementTypeCodeListIdentifierDataType that = ((FacilityManagementTypeCodeListIdentifierDataType) object);
        {
            String lhsValue;
