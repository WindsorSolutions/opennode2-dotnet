...
/**
 * <p>Java class for GeometricTypeCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GeometricTypeCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "GeometricTypeCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "GeometricTypeCodeListIdentifierDataType")
@Table(name = "OWIR_GEOMETRIC_TYPE_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class GeometricTypeCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "GEOMETRIC_TYPE_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GeometricTypeCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GeometricTypeCodeListIdentifierDataType that = ((GeometricTypeCodeListIdentifierDataType) object);
        {
            String lhsValue;
