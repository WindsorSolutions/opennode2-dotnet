...
/**
 * <p>Java class for TribalCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TribalCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "TribalCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "TribalCodeListIdentifierDataType")
@Table(name = "OWIR_TRIBAL_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class TribalCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "TRIBAL_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof TribalCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final TribalCodeListIdentifierDataType that = ((TribalCodeListIdentifierDataType) object);
        {
            String lhsValue;
