...
@Entity(name = "ResultQualifierCodeListIdentifierDataType")
@Table(name = "OWIR_RESULT_QUALIFIER_CODE_LIST_IDEN_DATA_TYPE")
    ...
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "RESULT_QUALIFIER_CODE_LIST_IDEN_DATA_TYPE_ID")
