...
/**
 * <p>Java class for ComplianceMilestoneTypeCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ComplianceMilestoneTypeCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "ComplianceMilestoneTypeCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "ComplianceMilestoneTypeCodeListIdentifierDataType")
@Table(name = "OWIR_COMPLIANCE_MILESTONE_TYPE_CODE_LIST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class ComplianceMilestoneTypeCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "COMPLIANCE_MILESTONE_TYPE_CODE_LIST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ComplianceMilestoneTypeCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ComplianceMilestoneTypeCodeListIdentifierDataType that = ((ComplianceMilestoneTypeCodeListIdentifierDataType) object);
        {
            String lhsValue;
