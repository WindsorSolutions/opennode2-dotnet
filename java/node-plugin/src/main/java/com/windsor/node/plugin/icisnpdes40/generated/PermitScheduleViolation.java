...
import com.windsor.node.plugin.icisnpdes40.domain.AbstractEnhancedPermitScheduleKeyElements;
...
/**
 * <p>Java class for PermitScheduleViolation complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PermitScheduleViolation">
 *   &lt;complexContent>
...
@XmlType(name = "PermitScheduleViolation", propOrder = {
    "scheduleEventCode",
    "scheduleDate"
})
@Entity(name = "PermitScheduleViolation")
@Table(name = "ICS_PRMT_SCHD_VIOL")
@Inheritance(strategy = InheritanceType.JOINED)
public class PermitScheduleViolation
    extends AbstractEnhancedPermitScheduleKeyElements
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "ICS_PRMT_SCHD_VIOL_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PermitScheduleViolation)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final PermitScheduleViolation that = ((PermitScheduleViolation) object);
        {
