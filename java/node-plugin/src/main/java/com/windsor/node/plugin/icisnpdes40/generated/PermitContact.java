...
/**
 * <p>Java class for PermitContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PermitContact">
 *   &lt;complexContent>
...
@XmlType(name = "PermitContact", propOrder = {
    "contact"
})
@Embeddable
public class PermitContact
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_PRMT_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof PermitContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final PermitContact that = ((PermitContact) object);
        {
