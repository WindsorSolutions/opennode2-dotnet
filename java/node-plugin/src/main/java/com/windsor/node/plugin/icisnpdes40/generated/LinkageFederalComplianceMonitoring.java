...
/**
 * <p>Java class for LinkageFederalComplianceMonitoring complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageFederalComplianceMonitoring">
 *   &lt;complexContent>
...
@XmlType(name = "LinkageFederalComplianceMonitoring", propOrder = {
...
@Entity(name = "LinkageFederalComplianceMonitoring")
@Table(name = "ICS_LNK_FEDR_CMPL_MON")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageFederalComplianceMonitoring
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Basic
    @Column(name = "PROG_SYSTM_ACRONYM", length = 20)
     ...
     */
    @Basic
    @Column(name = "PROG_SYSTM_IDENT", length = 30)
     ...
     */
    @Basic
    @Column(name = "FEDR_STATUTE_CODE", length = 6)
     ...
     */
    @Id
    @Column(name = "ICS_LNK_FEDR_CMPL_MON_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageFederalComplianceMonitoring)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageFederalComplianceMonitoring that = ((LinkageFederalComplianceMonitoring) object);
        {
