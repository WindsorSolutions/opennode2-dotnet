...
/**
 * <p>Java class for InspectionContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InspectionContact">
 *   &lt;complexContent>
...
@XmlType(name = "InspectionContact", propOrder = {
    "contact"
})
@Embeddable
    ...
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_INSP_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InspectionContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InspectionContact that = ((InspectionContact) object);
        {
