 ...
 *         &lt;element ref="{http://www.exchangenetwork.net/schema/icis/4}GeneralPermit"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
//        @AssociationOverride(name = "associatedPermit"),
//        @AssociationOverride(name = "sicCodeDetails"),
//        @AssociationOverride(name = "naicsCodeDetails"),
//        @AssociationOverride(name = "effluentGuidelineCode", joinTable = @JoinTable(name = "ICS_GNRL_PRMT_EFFLU_GUIDE_CODE", joinColumns = {
//            @JoinColumn(name = "DBID")
//        })),
//        @AssociationOverride(name = "permitContact.contact"),
//        @AssociationOverride(name = "permitAddress.address")
//    })
     ...
     *
     */
    public void setGeneralPermit(final GeneralPermit value) {
