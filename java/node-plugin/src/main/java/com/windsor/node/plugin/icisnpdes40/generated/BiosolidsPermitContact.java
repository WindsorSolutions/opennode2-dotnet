...
/**
 * <p>Java class for BiosolidsPermitContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BiosolidsPermitContact">
 *   &lt;complexContent>
...
@XmlType(name = "BiosolidsPermitContact", propOrder = {
    "contact"
})
@Embeddable
public class BiosolidsPermitContact
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_BS_PRMT_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BiosolidsPermitContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BiosolidsPermitContact that = ((BiosolidsPermitContact) object);
        {
