...
/**
 * <p>Java class for LinkageEnforcementAction complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LinkageEnforcementAction">
 *   &lt;complexContent>
...
@XmlType(name = "LinkageEnforcementAction", propOrder = {
    "enforcementActionIdentifier"
})
@Entity(name = "LinkageEnforcementAction")
@Table(name = "ICS_LNK_ENFRC_ACTN")
@Inheritance(strategy = InheritanceType.JOINED)
public class LinkageEnforcementAction
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "ICS_LNK_ENFRC_ACTN_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkageEnforcementAction)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkageEnforcementAction that = ((LinkageEnforcementAction) object);
        {
