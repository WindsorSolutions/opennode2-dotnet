...
/**
 * <p>Java class for FacilityContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FacilityContact">
 *   &lt;complexContent>
...
@XmlType(name = "FacilityContact", propOrder = {
    "contact"
})
@Embeddable
    ...
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_FAC_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FacilityContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FacilityContact that = ((FacilityContact) object);
        {
