...
/**
 * <p>Java class for SiteOwnerContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SiteOwnerContact">
 *   &lt;complexContent>
...
@XmlType(name = "SiteOwnerContact", propOrder = {
    "contact"
})
@Embeddable
public class SiteOwnerContact
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_SITE_OWNER_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SiteOwnerContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SiteOwnerContact that = ((SiteOwnerContact) object);
        {
