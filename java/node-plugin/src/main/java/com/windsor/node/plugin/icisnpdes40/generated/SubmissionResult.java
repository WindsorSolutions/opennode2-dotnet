 ...
 *         &lt;element name="TransactionType" type="{http://www.exchangenetwork.net/schema/icis/4}TransactionType"/>
 *         &lt;element name="PermitIdentifier" type="{http://www.exchangenetwork.net/schema/icis/4}String9FixedType" minOccurs="0"/>
 *         &lt;element name="PermitIdentifier2" type="{http://www.exchangenetwork.net/schema/icis/4}String9FixedType" minOccurs="0"/>
 ...
 *         &lt;element name="NumericReportViolationCode" type="{http://www.exchangenetwork.net/schema/icis/4}NumericReportViolationCodeType" minOccurs="0"/>
 ...
 *         &lt;element name="FinalOrderIdentifier" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="FinalOrderIdentifier2" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 ...
 *         &lt;element name="ScheduleViolationCode" type="{http://www.exchangenetwork.net/schema/icis/4}ScheduleViolationCodeType" minOccurs="0"/>
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @XmlElement(name = "ComplianceMonitoringCategoryCode2")
    ...
    @XmlElement(name = "ComplianceMonitoringDate2", type = String.class)
    @XmlJavaTypeAdapter(DateAdapter.class)
    @XmlSchemaType(name = "date")
     ...
     *
     */
    public void setComplianceMonitoringCategoryCode2(String value) {
     ...
     *
     */
    public void setComplianceMonitoringDate2(Date value) {
     ...
     */
    @Basic
    @Column(name = "FINAL_ORDER_IDENT", precision = 10, scale = 0)
     ...
     */
    @Basic
    @Column(name = "FINAL_ORDER_IDENT_2", precision = 10, scale = 0)
     ...
     *
     */
    public void setFinalOrderIdentifier2(Integer value) {
     ...
     */
    @Id
    @Column(name = "ICS_SUBM_RESULTS_ID", columnDefinition = "char(36)", length = 36)
    ...
    /**
     * FIXME Refactor and put CreatedDate into a superclass, field is not defined in XSD and therefore not generated by hyperJaxb
     *
     * @return
     *     possible object is
     *     {@link Date }
