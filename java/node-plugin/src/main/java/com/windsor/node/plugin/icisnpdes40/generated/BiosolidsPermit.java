...
// Generated on: 2012.08.29 at 08:24:06 PM PDT
//
    ...
    implements Serializable, Equals, HashCode
{
    ...
    // FIXME: added joinColumns
    @CollectionTable(name = "ICS_BS_TYPE", joinColumns = @JoinColumn(name = "ICS_BS_PRMT_ID"))
     ...
     *
     */
    public void setBiosolidsTypeCode(final List<String> biosolidsTypeCode) {
    ...
    // FIXME: added joinColumns
    @CollectionTable(name = "ICS_BS_END_USE_DSPL_TYPE", joinColumns = @JoinColumn(name = "ICS_BS_PRMT_ID"))
     ...
     *
     */
    public void setBiosolidsEndUseDisposalTypeCode(final List<String> biosolidsEndUseDisposalTypeCode) {
     ...
     *
     */
    public void setBiosolidsPermitContact(final BiosolidsPermitContact value) {
     ...
     *
     */
    public void setBiosolidsPermitAddress(final BiosolidsPermitAddress value) {
