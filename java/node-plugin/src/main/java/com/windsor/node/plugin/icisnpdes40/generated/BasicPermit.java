...
// Generated on: 2012.08.29 at 01:36:57 PM PDT
//
...
/**
 * <p>
 * Java class for BasicPermit complex type.
 *
 * <p>
...
@XmlType(name = "BasicPermit", propOrder = { "permitTypeCode", "agencyTypeCode",
		"permitStatusCode", "permitIssueDate", "permitEffectiveDate", "permitExpirationDate",
		"reissuancePriorityPermitIndicator", "backlogReasonText",
		"permitIssuingOrganizationTypeName", "otherPermits", "associatedPermit",
		"permitAppealedIndicator", "sicCodeDetails", "naicsCodeDetails",
		"permitUserDefinedDataElement1Text", "permitUserDefinedDataElement2Text",
		"permitUserDefinedDataElement3Text", "permitUserDefinedDataElement4Text",
		"permitUserDefinedDataElement5Text", "permitCommentsText", "majorMinorRatingCode",
		"totalApplicationDesignFlowNumber", "totalApplicationAverageFlowNumber", "facility",
		"applicationReceivedDate", "permitApplicationCompletionDate", "newSourceIndicator",
		"complianceTrackingStatus", "effluentGuidelineCode", "permitStateWaterBodyCode",
		"permitStateWaterBodyName", "federalGrantIndicator", "dmrCognizantOfficial",
		"dmrCognizantOfficialTelephoneNumber", "permitContact", "permitAddress",
		"significantIUIndicator", "receivingPermitIdentifier" })
@Embeddable
public class BasicPermit extends BasicPermitKeyElements implements Serializable, Equals, HashCode {
	...
	protected Double totalApplicationDesignFlowNumber;
	@XmlElement(name = "TotalApplicationAverageFlowNumber", type = String.class)
	@XmlJavaTypeAdapter(DoubleAdapter.class)
	protected Double totalApplicationAverageFlowNumber;
	 ...
	 *
	 */
	public void setPermitTypeCode(final String value) {
	 ...
	 *
	 */
	public void setAgencyTypeCode(final String value) {
	 ...
	 *
	 * @return possible object is {@link PermitStatusCodeType }
	 *
	 */
	@Basic
	 ...
	 *
	 * @param value
	 *            allowed object is {@link PermitStatusCodeType }
	 *
	 */
	public void setPermitStatusCode(final PermitStatusCodeType value) {
	 ...
	 *
	 */
	public void setPermitExpirationDate(final Date value) {
	 ...
	 *
	 */
	public void setReissuancePriorityPermitIndicator(final String value) {
	 ...
	 *
	 */
	public void setBacklogReasonText(final String value) {
	 ...
	 *
	 */
	public void setPermitIssuingOrganizationTypeName(final String value) {
	 ...
	 * <CODE>set</CODE> method for the otherPermits property.
	 *
	 * <p>
	 ...
	 *
	 */
	@OneToMany(targetEntity = OtherPermits.class, cascade = { CascadeType.ALL })
	// FIXME: added @JoinColumn
     ...
     *
     */
	public void setOtherPermits(final List<OtherPermits> otherPermits) {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the associatedPermit property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 *
	 */
	@OneToMany(targetEntity = AssociatedPermit.class, cascade = { CascadeType.ALL })
	// FIXME: added @JoinColumn
	@JoinColumn(name = "ICS_BASIC_PRMT_ID")
     ...
     *
     */
	public void setAssociatedPermit(final List<AssociatedPermit> associatedPermit) {
	 ...
	 *
	 */
	public void setPermitAppealedIndicator(final String value) {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the sicCodeDetails property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 *
	 */
	@OneToMany(targetEntity = SICCodeDetails.class, cascade = { CascadeType.ALL })
	// FIXME: added @JoinColumn
	@JoinColumn(name = "ICS_BASIC_PRMT_ID")
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the naicsCodeDetails property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	 ...
	 *
	 */
	@OneToMany(targetEntity = NAICSCodeDetails.class, cascade = { CascadeType.ALL })
	// FIXME: added @JoinColumn
	@JoinColumn(name = "ICS_BASIC_PRMT_ID")
	 ...
	 *
	 */
	public void setPermitUserDefinedDataElement1Text(final String value) {
	 ...
	 *
	 */
	public void setPermitUserDefinedDataElement2Text(final String value) {
	 ...
	 *
	 */
	public void setPermitUserDefinedDataElement3Text(final String value) {
	 ...
	 *
	 */
	public void setPermitUserDefinedDataElement4Text(final String value) {
	 ...
	 *
	 */
	public void setPermitUserDefinedDataElement5Text(final String value) {
	 ...
	 *
	 */
	public void setMajorMinorRatingCode(final Integer value) {
	...
	public Double getTotalApplicationDesignFlowNumber() {
	 ...
	 *
	 */
	public void setTotalApplicationDesignFlowNumber(final Double value) {
	...
	public Double getTotalApplicationAverageFlowNumber() {
	 ...
	 *
	 */
	public void setTotalApplicationAverageFlowNumber(final Double value) {
	 ...
	 *
	 * @return possible object is {@link Facility }
	 *
	 */
	// FIXME: changed to @OneToOne
	 ...
	 *
	 * @param value
	 *            allowed object is {@link Facility }
	 *
	 */
	public void setFacility(final Facility value) {
		this.facility = value;
	}
	 ...
	 *
	 */
	public void setApplicationReceivedDate(final Date value) {
	 ...
	 *
	 */
	public void setPermitApplicationCompletionDate(final Date value) {
	 ...
	 *
	 */
	public void setNewSourceIndicator(final String value) {
	 ...
	 *
	 * @return possible object is {@link ComplianceTrackingStatus }
	 *
	 */
	@OneToOne(targetEntity = ComplianceTrackingStatus.class, cascade = { CascadeType.ALL })
	 ...
	 *
	 * @param value
	 *            allowed object is {@link ComplianceTrackingStatus }
	 *
	 */
	public void setComplianceTrackingStatus(final ComplianceTrackingStatus value) {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the effluentGuidelineCode property.
	 *
	 * <p>
	 * For example, to add a new item, do as follows:
	 *
	...
	// FIMXE: Modified
	@CollectionTable(name = "ICS_EFFLU_GUIDE", joinColumns = @JoinColumn(name = "ICS_BASIC_PRMT_ID"))
     ...
     *
     */
	public void setEffluentGuidelineCode(final List<String> effluentGuidelineCode) {
	 ...
	 *
	 */
	public void setPermitStateWaterBodyCode(final String value) {
	 ...
	 *
	 */
	public void setPermitStateWaterBodyName(final String value) {
	 ...
	 *
	 */
	public void setFederalGrantIndicator(final String value) {
	 ...
	 *
	 */
	public void setDMRCognizantOfficial(final String value) {
	 ...
	 *
	 */
	public void setDMRCognizantOfficialTelephoneNumber(final String value) {
	 ...
	 *
	 * @return possible object is {@link PermitContact }
	 *
	 */
	@Embedded
	// FIXME: commented out
	 ...
	 *
	 * @param value
	 *            allowed object is {@link PermitContact }
	 *
	 */
	public void setPermitContact(final PermitContact value) {
	 ...
	 *
	 * @return possible object is {@link PermitAddress }
	 *
	 */
	@Embedded
	// FIXME: commented this out
	 ...
	 *
	 * @param value
	 *            allowed object is {@link PermitAddress }
	 *
	 */
	public void setPermitAddress(final PermitAddress value) {
	 ...
	 *
	 */
	public void setSignificantIUIndicator(final String value) {
	 ...
	 *
	 */
	public void setReceivingPermitIdentifier(final String value) {
	...
	public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator,
		...
		final BasicPermit that = ((BasicPermit) object);
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "permitTypeCode", lhsPermitTypeCode),
					LocatorUtils.property(thatLocator, "permitTypeCode", rhsPermitTypeCode),
					lhsPermitTypeCode, rhsPermitTypeCode)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "agencyTypeCode", lhsAgencyTypeCode),
					LocatorUtils.property(thatLocator, "agencyTypeCode", rhsAgencyTypeCode),
					lhsAgencyTypeCode, rhsAgencyTypeCode)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "permitStatusCode", lhsPermitStatusCode),
					LocatorUtils.property(thatLocator, "permitStatusCode", rhsPermitStatusCode),
					lhsPermitStatusCode, rhsPermitStatusCode)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "permitIssueDate", lhsPermitIssueDate),
					LocatorUtils.property(thatLocator, "permitIssueDate", rhsPermitIssueDate),
					lhsPermitIssueDate, rhsPermitIssueDate)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "permitEffectiveDate",
					lhsPermitEffectiveDate), LocatorUtils.property(thatLocator,
					"permitEffectiveDate", rhsPermitEffectiveDate), lhsPermitEffectiveDate,
					rhsPermitEffectiveDate)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "permitExpirationDate",
					lhsPermitExpirationDate), LocatorUtils.property(thatLocator,
					"permitExpirationDate", rhsPermitExpirationDate), lhsPermitExpirationDate,
					rhsPermitExpirationDate)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"reissuancePriorityPermitIndicator", lhsReissuancePriorityPermitIndicator),
					LocatorUtils.property(thatLocator, "reissuancePriorityPermitIndicator",
							rhsReissuancePriorityPermitIndicator),
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "backlogReasonText", lhsBacklogReasonText),
					LocatorUtils.property(thatLocator, "backlogReasonText", rhsBacklogReasonText),
					lhsBacklogReasonText, rhsBacklogReasonText)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitIssuingOrganizationTypeName", lhsPermitIssuingOrganizationTypeName),
					LocatorUtils.property(thatLocator, "permitIssuingOrganizationTypeName",
							rhsPermitIssuingOrganizationTypeName),
					lhsPermitIssuingOrganizationTypeName, rhsPermitIssuingOrganizationTypeName)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "otherPermits", lhsOtherPermits),
					LocatorUtils.property(thatLocator, "otherPermits", rhsOtherPermits),
					lhsOtherPermits, rhsOtherPermits)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "associatedPermit", lhsAssociatedPermit),
					LocatorUtils.property(thatLocator, "associatedPermit", rhsAssociatedPermit),
					lhsAssociatedPermit, rhsAssociatedPermit)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "permitAppealedIndicator",
					lhsPermitAppealedIndicator), LocatorUtils.property(thatLocator,
					"permitAppealedIndicator", rhsPermitAppealedIndicator),
					lhsPermitAppealedIndicator, rhsPermitAppealedIndicator)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "sicCodeDetails", lhsSICCodeDetails),
					LocatorUtils.property(thatLocator, "sicCodeDetails", rhsSICCodeDetails),
					lhsSICCodeDetails, rhsSICCodeDetails)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "naicsCodeDetails", lhsNAICSCodeDetails),
					LocatorUtils.property(thatLocator, "naicsCodeDetails", rhsNAICSCodeDetails),
					lhsNAICSCodeDetails, rhsNAICSCodeDetails)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitUserDefinedDataElement1Text", lhsPermitUserDefinedDataElement1Text),
					LocatorUtils.property(thatLocator, "permitUserDefinedDataElement1Text",
							rhsPermitUserDefinedDataElement1Text),
					lhsPermitUserDefinedDataElement1Text, rhsPermitUserDefinedDataElement1Text)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitUserDefinedDataElement2Text", lhsPermitUserDefinedDataElement2Text),
					LocatorUtils.property(thatLocator, "permitUserDefinedDataElement2Text",
							rhsPermitUserDefinedDataElement2Text),
					lhsPermitUserDefinedDataElement2Text, rhsPermitUserDefinedDataElement2Text)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitUserDefinedDataElement3Text", lhsPermitUserDefinedDataElement3Text),
					LocatorUtils.property(thatLocator, "permitUserDefinedDataElement3Text",
							rhsPermitUserDefinedDataElement3Text),
					lhsPermitUserDefinedDataElement3Text, rhsPermitUserDefinedDataElement3Text)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitUserDefinedDataElement4Text", lhsPermitUserDefinedDataElement4Text),
					LocatorUtils.property(thatLocator, "permitUserDefinedDataElement4Text",
							rhsPermitUserDefinedDataElement4Text),
					lhsPermitUserDefinedDataElement4Text, rhsPermitUserDefinedDataElement4Text)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitUserDefinedDataElement5Text", lhsPermitUserDefinedDataElement5Text),
					LocatorUtils.property(thatLocator, "permitUserDefinedDataElement5Text",
							rhsPermitUserDefinedDataElement5Text),
					lhsPermitUserDefinedDataElement5Text, rhsPermitUserDefinedDataElement5Text)) {
				return false;
			}
		}
		{
			...
			if (!strategy
					.equals(LocatorUtils.property(thisLocator, "permitCommentsText",
							lhsPermitCommentsText), LocatorUtils.property(thatLocator,
							"permitCommentsText", rhsPermitCommentsText), lhsPermitCommentsText,
							rhsPermitCommentsText)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "majorMinorRatingCode",
					lhsMajorMinorRatingCode), LocatorUtils.property(thatLocator,
					"majorMinorRatingCode", rhsMajorMinorRatingCode), lhsMajorMinorRatingCode,
					rhsMajorMinorRatingCode)) {
				return false;
			}
		}
		{
			Double lhsTotalApplicationDesignFlowNumber;
			lhsTotalApplicationDesignFlowNumber = this.getTotalApplicationDesignFlowNumber();
			Double rhsTotalApplicationDesignFlowNumber;
			rhsTotalApplicationDesignFlowNumber = that.getTotalApplicationDesignFlowNumber();
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"totalApplicationDesignFlowNumber", lhsTotalApplicationDesignFlowNumber),
					LocatorUtils.property(thatLocator, "totalApplicationDesignFlowNumber",
							rhsTotalApplicationDesignFlowNumber),
					lhsTotalApplicationDesignFlowNumber, rhsTotalApplicationDesignFlowNumber)) {
				return false;
			}
		}
		{
			Double lhsTotalApplicationAverageFlowNumber;
			lhsTotalApplicationAverageFlowNumber = this.getTotalApplicationAverageFlowNumber();
			Double rhsTotalApplicationAverageFlowNumber;
			rhsTotalApplicationAverageFlowNumber = that.getTotalApplicationAverageFlowNumber();
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"totalApplicationAverageFlowNumber", lhsTotalApplicationAverageFlowNumber),
					LocatorUtils.property(thatLocator, "totalApplicationAverageFlowNumber",
							rhsTotalApplicationAverageFlowNumber),
					lhsTotalApplicationAverageFlowNumber, rhsTotalApplicationAverageFlowNumber)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "facility", lhsFacility),
					LocatorUtils.property(thatLocator, "facility", rhsFacility), lhsFacility,
					rhsFacility)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "applicationReceivedDate",
					lhsApplicationReceivedDate), LocatorUtils.property(thatLocator,
					"applicationReceivedDate", rhsApplicationReceivedDate),
					lhsApplicationReceivedDate, rhsApplicationReceivedDate)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"permitApplicationCompletionDate", lhsPermitApplicationCompletionDate),
					LocatorUtils.property(thatLocator, "permitApplicationCompletionDate",
							rhsPermitApplicationCompletionDate),
					lhsPermitApplicationCompletionDate, rhsPermitApplicationCompletionDate)) {
				return false;
			}
		}
		{
			...
			if (!strategy
					.equals(LocatorUtils.property(thisLocator, "newSourceIndicator",
							lhsNewSourceIndicator), LocatorUtils.property(thatLocator,
							"newSourceIndicator", rhsNewSourceIndicator), lhsNewSourceIndicator,
							rhsNewSourceIndicator)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "complianceTrackingStatus",
					lhsComplianceTrackingStatus), LocatorUtils.property(thatLocator,
					"complianceTrackingStatus", rhsComplianceTrackingStatus),
					lhsComplianceTrackingStatus, rhsComplianceTrackingStatus)) {
				return false;
			}
		}
		{
			List<String> lhsEffluentGuidelineCode;
			lhsEffluentGuidelineCode = (this.isSetEffluentGuidelineCode() ? this
					.getEffluentGuidelineCode() : null);
			List<String> rhsEffluentGuidelineCode;
			rhsEffluentGuidelineCode = (that.isSetEffluentGuidelineCode() ? that
					.getEffluentGuidelineCode() : null);
			if (!strategy.equals(LocatorUtils.property(thisLocator, "effluentGuidelineCode",
					lhsEffluentGuidelineCode), LocatorUtils.property(thatLocator,
					"effluentGuidelineCode", rhsEffluentGuidelineCode), lhsEffluentGuidelineCode,
					rhsEffluentGuidelineCode)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "permitStateWaterBodyCode",
					lhsPermitStateWaterBodyCode), LocatorUtils.property(thatLocator,
					"permitStateWaterBodyCode", rhsPermitStateWaterBodyCode),
					lhsPermitStateWaterBodyCode, rhsPermitStateWaterBodyCode)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "permitStateWaterBodyName",
					lhsPermitStateWaterBodyName), LocatorUtils.property(thatLocator,
					"permitStateWaterBodyName", rhsPermitStateWaterBodyName),
					lhsPermitStateWaterBodyName, rhsPermitStateWaterBodyName)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "federalGrantIndicator",
					lhsFederalGrantIndicator), LocatorUtils.property(thatLocator,
					"federalGrantIndicator", rhsFederalGrantIndicator), lhsFederalGrantIndicator,
					rhsFederalGrantIndicator)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "dmrCognizantOfficial",
					lhsDMRCognizantOfficial), LocatorUtils.property(thatLocator,
					"dmrCognizantOfficial", rhsDMRCognizantOfficial), lhsDMRCognizantOfficial,
					rhsDMRCognizantOfficial)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator,
					"dmrCognizantOfficialTelephoneNumber", lhsDMRCognizantOfficialTelephoneNumber),
		...
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "permitContact", lhsPermitContact),
					LocatorUtils.property(thatLocator, "permitContact", rhsPermitContact),
					lhsPermitContact, rhsPermitContact)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(
					LocatorUtils.property(thisLocator, "permitAddress", lhsPermitAddress),
					LocatorUtils.property(thatLocator, "permitAddress", rhsPermitAddress),
					lhsPermitAddress, rhsPermitAddress)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "significantIUIndicator",
					lhsSignificantIUIndicator), LocatorUtils.property(thatLocator,
					"significantIUIndicator", rhsSignificantIUIndicator),
					lhsSignificantIUIndicator, rhsSignificantIUIndicator)) {
				return false;
			}
		}
		{
			...
			if (!strategy.equals(LocatorUtils.property(thisLocator, "receivingPermitIdentifier",
					lhsReceivingPermitIdentifier), LocatorUtils.property(thatLocator,
					"receivingPermitIdentifier", rhsReceivingPermitIdentifier),
					lhsReceivingPermitIdentifier, rhsReceivingPermitIdentifier)) {
				return false;
			}
		}
		return true;
	...
	public int hashCode(final ObjectLocator locator, final HashCodeStrategy strategy) {
		int currentHashCode = super.hashCode(locator, strategy);
		{
			...
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitTypeCode", thePermitTypeCode),
					currentHashCode, thePermitTypeCode);
		}
		{
			String theAgencyTypeCode;
			theAgencyTypeCode = this.getAgencyTypeCode();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "agencyTypeCode", theAgencyTypeCode),
					currentHashCode, theAgencyTypeCode);
		}
		{
			PermitStatusCodeType thePermitStatusCode;
			thePermitStatusCode = this.getPermitStatusCode();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitStatusCode", thePermitStatusCode),
					currentHashCode, thePermitStatusCode);
		}
		{
			Date thePermitIssueDate;
			thePermitIssueDate = this.getPermitIssueDate();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitIssueDate", thePermitIssueDate),
					currentHashCode, thePermitIssueDate);
		}
		{
			Date thePermitEffectiveDate;
			thePermitEffectiveDate = this.getPermitEffectiveDate();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitEffectiveDate", thePermitEffectiveDate),
					currentHashCode, thePermitEffectiveDate);
		}
		{
			Date thePermitExpirationDate;
			thePermitExpirationDate = this.getPermitExpirationDate();
			currentHashCode = strategy
					.hashCode(LocatorUtils.property(locator, "permitExpirationDate",
							thePermitExpirationDate), currentHashCode, thePermitExpirationDate);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"reissuancePriorityPermitIndicator", theReissuancePriorityPermitIndicator),
					currentHashCode, theReissuancePriorityPermitIndicator);
		}
		{
			String theBacklogReasonText;
			theBacklogReasonText = this.getBacklogReasonText();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "backlogReasonText", theBacklogReasonText),
					currentHashCode, theBacklogReasonText);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitIssuingOrganizationTypeName", thePermitIssuingOrganizationTypeName),
					currentHashCode, thePermitIssuingOrganizationTypeName);
		}
		{
			List<OtherPermits> theOtherPermits;
			theOtherPermits = (this.isSetOtherPermits() ? this.getOtherPermits() : null);
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "otherPermits", theOtherPermits),
					currentHashCode, theOtherPermits);
		}
		{
			List<AssociatedPermit> theAssociatedPermit;
			theAssociatedPermit = (this.isSetAssociatedPermit() ? this.getAssociatedPermit() : null);
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "associatedPermit", theAssociatedPermit),
					currentHashCode, theAssociatedPermit);
		}
		{
			String thePermitAppealedIndicator;
			thePermitAppealedIndicator = this.getPermitAppealedIndicator();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitAppealedIndicator", thePermitAppealedIndicator), currentHashCode,
					thePermitAppealedIndicator);
		}
		{
			List<SICCodeDetails> theSICCodeDetails;
			theSICCodeDetails = (this.isSetSICCodeDetails() ? this.getSICCodeDetails() : null);
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "sicCodeDetails", theSICCodeDetails),
					currentHashCode, theSICCodeDetails);
		}
		{
			List<NAICSCodeDetails> theNAICSCodeDetails;
			theNAICSCodeDetails = (this.isSetNAICSCodeDetails() ? this.getNAICSCodeDetails() : null);
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "naicsCodeDetails", theNAICSCodeDetails),
					currentHashCode, theNAICSCodeDetails);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitUserDefinedDataElement1Text", thePermitUserDefinedDataElement1Text),
					currentHashCode, thePermitUserDefinedDataElement1Text);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitUserDefinedDataElement2Text", thePermitUserDefinedDataElement2Text),
					currentHashCode, thePermitUserDefinedDataElement2Text);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitUserDefinedDataElement3Text", thePermitUserDefinedDataElement3Text),
					currentHashCode, thePermitUserDefinedDataElement3Text);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitUserDefinedDataElement4Text", thePermitUserDefinedDataElement4Text),
					currentHashCode, thePermitUserDefinedDataElement4Text);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitUserDefinedDataElement5Text", thePermitUserDefinedDataElement5Text),
					currentHashCode, thePermitUserDefinedDataElement5Text);
		}
		{
			String thePermitCommentsText;
			thePermitCommentsText = this.getPermitCommentsText();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitCommentsText", thePermitCommentsText),
					currentHashCode, thePermitCommentsText);
		}
		{
			Integer theMajorMinorRatingCode;
			theMajorMinorRatingCode = this.getMajorMinorRatingCode();
			currentHashCode = strategy
					.hashCode(LocatorUtils.property(locator, "majorMinorRatingCode",
							theMajorMinorRatingCode), currentHashCode, theMajorMinorRatingCode);
		}
		{
			Double theTotalApplicationDesignFlowNumber;
			theTotalApplicationDesignFlowNumber = this.getTotalApplicationDesignFlowNumber();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"totalApplicationDesignFlowNumber", theTotalApplicationDesignFlowNumber),
					currentHashCode, theTotalApplicationDesignFlowNumber);
		}
		{
			Double theTotalApplicationAverageFlowNumber;
			theTotalApplicationAverageFlowNumber = this.getTotalApplicationAverageFlowNumber();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"totalApplicationAverageFlowNumber", theTotalApplicationAverageFlowNumber),
					currentHashCode, theTotalApplicationAverageFlowNumber);
		}
		{
			Facility theFacility;
			theFacility = this.getFacility();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "facility", theFacility), currentHashCode,
					theFacility);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"applicationReceivedDate", theApplicationReceivedDate), currentHashCode,
					theApplicationReceivedDate);
		}
		{
			Date thePermitApplicationCompletionDate;
			thePermitApplicationCompletionDate = this.getPermitApplicationCompletionDate();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitApplicationCompletionDate", thePermitApplicationCompletionDate),
					currentHashCode, thePermitApplicationCompletionDate);
		}
		{
			String theNewSourceIndicator;
			theNewSourceIndicator = this.getNewSourceIndicator();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "newSourceIndicator", theNewSourceIndicator),
					currentHashCode, theNewSourceIndicator);
		}
		{
			ComplianceTrackingStatus theComplianceTrackingStatus;
			theComplianceTrackingStatus = this.getComplianceTrackingStatus();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"complianceTrackingStatus", theComplianceTrackingStatus), currentHashCode,
					theComplianceTrackingStatus);
		}
		{
			List<String> theEffluentGuidelineCode;
			theEffluentGuidelineCode = (this.isSetEffluentGuidelineCode() ? this
					.getEffluentGuidelineCode() : null);
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"effluentGuidelineCode", theEffluentGuidelineCode), currentHashCode,
					theEffluentGuidelineCode);
		}
		{
			String thePermitStateWaterBodyCode;
			thePermitStateWaterBodyCode = this.getPermitStateWaterBodyCode();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitStateWaterBodyCode", thePermitStateWaterBodyCode), currentHashCode,
					thePermitStateWaterBodyCode);
		}
		{
			String thePermitStateWaterBodyName;
			thePermitStateWaterBodyName = this.getPermitStateWaterBodyName();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"permitStateWaterBodyName", thePermitStateWaterBodyName), currentHashCode,
					thePermitStateWaterBodyName);
		}
		{
			String theFederalGrantIndicator;
			theFederalGrantIndicator = this.getFederalGrantIndicator();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"federalGrantIndicator", theFederalGrantIndicator), currentHashCode,
					theFederalGrantIndicator);
		}
		{
			String theDMRCognizantOfficial;
			theDMRCognizantOfficial = this.getDMRCognizantOfficial();
			currentHashCode = strategy
					.hashCode(LocatorUtils.property(locator, "dmrCognizantOfficial",
							theDMRCognizantOfficial), currentHashCode, theDMRCognizantOfficial);
		}
		{
			...
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"dmrCognizantOfficialTelephoneNumber", theDMRCognizantOfficialTelephoneNumber),
					currentHashCode, theDMRCognizantOfficialTelephoneNumber);
		}
		{
			PermitContact thePermitContact;
			thePermitContact = this.getPermitContact();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitContact", thePermitContact),
					currentHashCode, thePermitContact);
		}
		{
			PermitAddress thePermitAddress;
			thePermitAddress = this.getPermitAddress();
			currentHashCode = strategy.hashCode(
					LocatorUtils.property(locator, "permitAddress", thePermitAddress),
					currentHashCode, thePermitAddress);
		}
		{
			String theSignificantIUIndicator;
			theSignificantIUIndicator = this.getSignificantIUIndicator();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"significantIUIndicator", theSignificantIUIndicator), currentHashCode,
					theSignificantIUIndicator);
		}
		{
			String theReceivingPermitIdentifier;
			theReceivingPermitIdentifier = this.getReceivingPermitIdentifier();
			currentHashCode = strategy.hashCode(LocatorUtils.property(locator,
					"receivingPermitIdentifier", theReceivingPermitIdentifier), currentHashCode,
					theReceivingPermitIdentifier);
		}
