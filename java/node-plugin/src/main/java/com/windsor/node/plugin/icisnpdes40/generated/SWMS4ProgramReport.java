...
/**
 * <p>Java class for SWMS4ProgramReport complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="SWMS4ProgramReport">
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.exchangenetwork.net/schema/icis/4}SWMS4ProgramReportKeyElements">
 *       &lt;sequence>
...
@XmlType(name = "SWMS4ProgramReport", propOrder = {
...
@Embeddable
public class SWMS4ProgramReport
    extends SWMS4ProgramReportKeyElements
    implements Serializable, Equals, HashCode
{
    ...
    @CollectionTable(name = "ICS_PROJ_SRCS_FUND", joinColumns = @JoinColumn(name = "ICS_SWMS_4_PROG_REP_ID"))
     ...
     *
     */
    public void setProjectedSourcesFundingCode(final List<String> projectedSourcesFundingCode) {
    ...
    @Embedded
    // FIXME: added join column
    @AssociationOverride(name = "contact", joinColumns = @JoinColumn(name = "ICS_SWMS_4_PROG_REP_ID"))
    ...
    @Embedded
    // FIXME: added join column
    @AssociationOverride(name = "address", joinColumns = @JoinColumn(name = "ICS_SWMS_4_PROG_REP_ID"))
	...
	public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        if (!(object instanceof SWMS4ProgramReport)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SWMS4ProgramReport that = ((SWMS4ProgramReport) object);
        {
