...
// Generated on: 2012.08.30 at 09:33:05 AM PDT
//
...
/**
 * <p>Java class for SWMS4LargePermit complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="SWMS4LargePermit">
 *   &lt;complexContent>
...
@XmlType(name = "SWMS4LargePermit", propOrder = {
    "stateWaterBodyName",
    "receivingMS4Name",
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @Embedded
    // FIXME: fixed
    @AssociationOverride(name = "contact", joinColumns = @JoinColumn(name = "ICS_SWMS_4_LARGE_PRMT_ID"))
     ...
     */
    @Embedded
    // FIXME: fixed override
    @AssociationOverride(name = "address", joinColumns = @JoinColumn(name = "ICS_SWMS_4_LARGE_PRMT_ID"))
	...
	public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object, final EqualsStrategy strategy) {
        if (!(object instanceof SWMS4LargePermit)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final SWMS4LargePermit that = ((SWMS4LargePermit) object);
        {
