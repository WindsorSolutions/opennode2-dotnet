...
/**
 * <p>Java class for CAFOContact complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CAFOContact">
 *   &lt;complexContent>
...
@XmlType(name = "CAFOContact", propOrder = {
    "contact"
})
@Embeddable
public class CAFOContact
    implements Serializable, IContactList, Equals, HashCode
{
    ...
    @JoinColumn(name = "ICS_CAFO_CONTACT_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CAFOContact)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CAFOContact that = ((CAFOContact) object);
        {
