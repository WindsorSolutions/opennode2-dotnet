...
/**
 * <p>Java class for RecurringEventLocationDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RecurringEventLocationDataType">
 *   &lt;complexContent>
...
@XmlType(name = "RecurringEventLocationDataType", propOrder = {
    "locationIdentifier"
})
@Entity(name = "RecurringEventLocationDataType")
@Table(name = "IC_RECR_EVT_LOC")
@Inheritance(strategy = InheritanceType.JOINED)
public class RecurringEventLocationDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "IC_RECR_EVT_LOC_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RecurringEventLocationDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RecurringEventLocationDataType that = ((RecurringEventLocationDataType) object);
        {
