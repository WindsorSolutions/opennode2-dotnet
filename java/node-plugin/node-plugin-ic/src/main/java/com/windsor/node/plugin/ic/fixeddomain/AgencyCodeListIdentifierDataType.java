...
/**
 * <p>Java class for AgencyCodeListIdentifierDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AgencyCodeListIdentifierDataType">
 *   &lt;simpleContent>
...
@XmlType(name = "AgencyCodeListIdentifierDataType", propOrder = {
    "value"
})
@Entity(name = "AgencyCodeListIdentifierDataType")
@Table(name = "IC_AGENCY_CODE_LST_IDEN_DATA_TYPE")
@Inheritance(strategy = InheritanceType.JOINED)
public class AgencyCodeListIdentifierDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "AGENCY_CODE_LST_IDEN_DATA_TYPE_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AgencyCodeListIdentifierDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AgencyCodeListIdentifierDataType that = ((AgencyCodeListIdentifierDataType) object);
        {
            String lhsValue;
