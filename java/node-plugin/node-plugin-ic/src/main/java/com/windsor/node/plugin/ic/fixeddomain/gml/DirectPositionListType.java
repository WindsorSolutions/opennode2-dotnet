...
@Entity(name = "DirectPositionListType")
@Table(name = "IC_DIRECT_POSITION_LST_TYPE")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    @CollectionTable(name = "IC_VALUE", joinColumns = {
        @JoinColumn(name = "DIRECT_POSITION_LST_TYPE_ID")
    })
     ...
     */
    @Basic
    @Column(name = "COUNT", precision = 20, scale = 0)
     ...
     */
    @Id
    @Column(name = "DIRECT_POSITION_LST_TYPE_ID")
