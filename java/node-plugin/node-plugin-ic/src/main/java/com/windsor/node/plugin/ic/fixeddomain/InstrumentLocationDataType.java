...
/**
 * <p>Java class for InstrumentLocationDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InstrumentLocationDataType">
 *   &lt;complexContent>
...
@XmlType(name = "InstrumentLocationDataType", propOrder = {
    "locationIdentifier"
})
@Entity(name = "InstrumentLocationDataType")
@Table(name = "IC_INSTR_LOC")
@Inheritance(strategy = InheritanceType.JOINED)
public class InstrumentLocationDataType
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof InstrumentLocationDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final InstrumentLocationDataType that = ((InstrumentLocationDataType) object);
        {
