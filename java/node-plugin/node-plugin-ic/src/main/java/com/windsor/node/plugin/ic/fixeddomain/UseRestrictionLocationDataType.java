...
/**
 * <p>Java class for UseRestrictionLocationDataType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UseRestrictionLocationDataType">
 *   &lt;complexContent>
...
@XmlType(name = "UseRestrictionLocationDataType", propOrder = {
    "locationIdentifier"
})
@Entity(name = "UseRestrictionLocationDataType")
@Table(name = "IC_USE_RSTCT_LOC")
@Inheritance(strategy = InheritanceType.JOINED)
public class UseRestrictionLocationDataType
    implements Serializable, Equals, HashCode
{
     ...
     */
    @Id
    @Column(name = "IC_USE_RSTCT_LOC_ID")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UseRestrictionLocationDataType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UseRestrictionLocationDataType that = ((UseRestrictionLocationDataType) object);
        {
