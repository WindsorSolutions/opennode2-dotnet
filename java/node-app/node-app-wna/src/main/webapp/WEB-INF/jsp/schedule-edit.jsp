...
<table id="contentTable">
    <tr>
        ...
        <table id="formTable" width="100%" cellpadding="2" cellspacing="0">     
            ...
            <!-- AUDIT LINE -->
            <tr>
                <td class="label" width="5%" style="text-align: right; vertical-align: top;">Audit:</td>
                <td class="ctrl" width="95%">
                    Last modified by <c:out value="${command.modifiedById}" /> on <c:out value="${command.modifiedOn}" />.
                </td>
            </tr>
            <!-- /AUDIT LINE -->
    ...
    function setFrequencyLogic(){
        ...
        switch($("#frequencyType").val())
        {
            ...
            case 'Months':
                ...
                $("#frequencyNum").removeClass("disabledInput");
                break;
